...
- Name: summative_evaluation.spec.ts >> Summative Evaluation Gating and Warnings >> should display the single-attempt warning checklist on the start screen for a summative quiz/essay
- Location: tests\summative_evaluation.spec.ts:19:7
...
Locator: locator('h3:has-text("Évaluation sommative")')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('h3:has-text("Évaluation sommative")')
