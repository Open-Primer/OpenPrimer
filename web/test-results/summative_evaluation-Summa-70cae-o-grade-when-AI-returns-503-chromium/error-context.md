...
- Name: summative_evaluation.spec.ts >> Summative Evaluation Gating and Warnings >> offline-blocked: shows service unavailable screen and no grade when AI returns 503
- Location: tests\summative_evaluation.spec.ts:45:7
...
Call log:
  - waiting for locator('button:has-text("Démarrer")').first()
