...
* Heading: "## Consignes Finales et Critères d'Évaluation"
  Instructions: "Fournir les dernières instructions pratiques pour l'examen (matériel autorisé, gestion du temps, présentation des réponses, structure attendue des dissertations ou analyses). Expliciter les critères de notation (précision des connaissances, rigueur de l'argumentation, clarté de l'expression, capacité à mobiliser des exemples pertinents)."
...
"""
...  des pistes pour la gestion future des ressources en eau.
