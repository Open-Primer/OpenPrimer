...
- Anchor: [[WIDGET:Mermaid:intro_num_methods_flow:Flux de travail des méthodes numériques en finance]] (Type: "Mermaid", ID: "intro_num_methods_flow", Topic: "Flux de travail des méthodes numériques en finance")
- Anchor: [[WIDGET:CustomFigure:monte_carlo_paths:Exemple de trajectoires de prix d'actif simulées par Monte Carlo]] (Type: "CustomFigure", ID: "monte_carlo_paths", Topic: "Exemple de trajectoires de prix d'actif simulées par Monte Carlo")
- Anchor: [[WIDGET:SolvedExercise:monte_carlo_european_call:Valorisation d'une option call européenne par Monte Carlo]] (Type: "SolvedExercise", ID: "monte_carlo_european_call", Topic: "Valorisation d'une option call européenne par Monte Carlo")
- Anchor: [[WIDGET:Image:black_scholes_pde:Représentation de l'équation de Black-Scholes, une EDP parabolique fondamentale en finance quantitative.]] (Type: "Image", ID: "black_scholes_pde", Topic: "Représentation de l'équation de Black-Scholes, une EDP parabolique fondamentale en finance quantitative.")
- Anchor: [[WIDGET:SolvedExercise:fdm_european_call:Implémentation d'un schéma explicite pour une option call européenne]] (Type: "SolvedExercise", ID: "fdm_european_call", Topic: "Implémentation d'un schéma explicite pour une option call européenne")
- Anchor: [[WIDGET:ComparisonSlider:mc_fdm_comparison]] (Type: "ComparisonSlider", ID: "mc_fdm_comparison", Topic: "")
- Anchor: [[WIDGET:Quiz:mc_fdm_quiz]] (Type: "Quiz", ID: "mc_fdm_quiz", Topic: "")
- Anchor: [[WIDGET:Mermaid:numerical_methods_roadmap:Évolution des méthodes numériques en finance]] (Type: "Mermaid", ID: "numerical_methods_roadmap", Topic: "Évolution des méthodes numériques en finance")
- Anchor: [[WIDGET:Quote:wilmott_future_quant:Citation de Paul Wilmott sur l'avenir de la finance quantitative]] (Type: "Quote", ID: "wilmott_future_quant", Topic: "Citation de Paul Wilmott sur l'avenir de la finance quantitative")
...
🚨 PREVIOUS CRITIQUE:
"The block contains an Image component that violates critical media rules. Image components must not contain the 'year' property. Specifically, the 'black_scholes_pde' Image component includes 'year' in its props.
Detailed errors:
- Field "interactiveComponents": The 'black_scholes_pde' Image component (at index 3) within 'interactiveComponents' includes a 'year' property in its 'props'. Image components are strictly forbidden from having 'year' (along with 'url', 'wikipediaUrl', 'wikipediaLink', 'imageUrl'). Please remove the 'year' property from this Image component."
