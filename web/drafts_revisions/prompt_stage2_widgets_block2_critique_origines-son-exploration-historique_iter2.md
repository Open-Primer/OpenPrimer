  ...
  "interactiveComponents": [
    {
      ...
      "props": {
        "description": "Branche de la physique qui étudie le son, les infrasons et les ultrasons, ainsi que leurs propriétés. Elle couvre la production, la propagation et les effets des ondes sonores dans divers milieux.",
        "name": "acoustique",
        "text": "Branche de la physique qui étudie le son, les infrasons et les ultrasons, ainsi que leurs propriétés. Elle couvre la production, la propagation et les effets des ondes sonores dans divers milieux.",
        "title": "acoustique"
      }
    },
    {
      ...
      "sectionAnchor": "Antiquité et Moyen Âge",
      "props": {
        "description": "Mathématicien et philosophe grec de l'Antiquité, fondateur de l'école pythagoricienne. Il est célèbre pour ses contributions à la théorie musicale, notamment la découverte des rapports numériques des intervalles musicaux, et pour le théorème de Pythagore en géométrie.",
        "name": "Pythagore"
      }
    }
  ]
