...
* Heading: "## Les couplages océan-atmosphère: l'exemple d'El Niño"
  Instructions: "Approfondir l'étude des interactions complexes entre l'océan et l'atmosphère. Utiliser le phénomène El Niño-Oscillation Australe (ENSO) comme cas d'étude pour illustrer ces couplages et leurs impacts climatiques à l'échelle planétaire."
* Heading: "## Conclusion et perspectives"
  Instructions: "Récapituler les points essentiels de la leçon sur l'interdépendance des circulations atmosphérique et océanique. Souligner leur rôle crucial dans la régulation climatique et ouvrir sur les enjeux futurs liés au changement climatique."
...
"""
... itudes thermiques importantes, précipitations concentrées en été ou faibles).
...
"The block contains unresolved placeholders for references (e.g., [ref1], [ref2], [ref6]) which must be replaced with actual citations or removed. More critically, the block fails to meet the pedagogical widget requirements. It is missing several mandated widget types, specifically: HistoricalAnecdote, SolvedExercise, UnsolvedExercise, and DataChart. The instructions explicitly state that the block must be rejected if these are not respected. These widgets need to be integrated into the lesson to provide a comprehensive and interactive learning experience."
