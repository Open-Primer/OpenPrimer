...
Your mission is to design the structure, lesson titles, and cognitive strategy of the course titled "Introduction à la sociologie contemporaine" for the level "University Year 1 / Bachelor 1st Year (L1)". You do not write the course content; you construct its pure, highly-adapted computational and educational backbone.
...
- **Course Title:** "Introduction à la sociologie contemporaine"
- **Target Level:** "University Year 1 / Bachelor 1st Year (L1)"
...
{
  "courseContext": {
    "discipline": "[Input discipline: 'Sociology', translated to FR]",
