...
- **Academic Level**: "L1"
- **Lesson Title**: "Les Sons du Langage : Introduction à la Phonétique Articulatoire"
- **Lesson Slug**: "sons-langage-phonetique-articulatoire"
- **Target Language**: "FR"
- **Course Discipline**: "Général"
- **Epistemological Matrix**: "Sciences humaines et discursives"
- **Expected Cognitive Artifact**: "Schémas de l'appareil phonatoire, transcription phonétique (API) simple, exercices de production et d'identification"
- **Expected Guidelines / Technical Depth**: "Description des organes de la parole et classification des sons (voyelles, consonnes) selon leurs lieux et modes d'articulation."
