...
* Heading: "## Introduction aux marchés financiers et aux crises"
  Instructions: "Présenter le cours, ses objectifs pédagogiques et l'importance de comprendre les dynamiques des marchés financiers, la formation des bulles et les mécanismes de crise dans le contexte macroéconomique. Esquisser brièvement les thèmes clés qui seront abordés."
* Heading: "## Le rôle du crédit et de l'effet de levier dans l'instabilité financière"
  Instructions: "Expliquer comment la création de crédit et l'effet de levier (leverage) peuvent amplifier les cycles économiques et contribuer à l'instabilité financière. Analyser les mécanismes par lesquels un excès de crédit peut mener à des prises de risque excessives et à la fragilisation du système financier."
...
- Lesson Title: "Marchés financiers, bulles et crises macroéconomiques"
- Discipline: "Économie"
- Target Language: "FR"
