...
- Anchor: [[WIDGET:Mermaid:course_progression:Schéma conceptuel de la progression du cours de Finance Quantitative]] (Type: "Mermaid", ID: "course_progression", Topic: "Schéma conceptuel de la progression du cours de Finance Quantitative")
- Anchor: [[WIDGET:Mermaid:filtration_concept:Illustration du concept de filtration et de l'accroissement de l'information au fil du temps]] (Type: "Mermaid", ID: "filtration_concept", Topic: "Illustration du concept de filtration et de l'accroissement de l'information au fil du temps")
- Anchor: [[WIDGET:CustomFigure:conditional_expectation_properties:Résumé des propriétés clés de l'espérance conditionnelle]] (Type: "CustomFigure", ID: "conditional_expectation_properties", Topic: "Résumé des propriétés clés de l'espérance conditionnelle")
- Anchor: [[WIDGET:CustomFigure:doob_inequality:Formulation de l'inégalité de Doob pour les martingales, illustrant la borne supérieure de la probabilité de dépassement d'un seuil]] (Type: "CustomFigure", ID: "doob_inequality", Topic: "Formulation de l'inégalité de Doob pour les martingales, illustrant la borne supérieure de la probabilité de dépassement d'un seuil")
- Anchor: [[WIDGET:Mermaid:crr_model_tree:Arbre des prix du modèle binomial de Cox-Ross-Rubinstein sur plusieurs périodes]] (Type: "Mermaid", ID: "crr_model_tree", Topic: "Arbre des prix du modèle binomial de Cox-Ross-Rubinstein sur plusieurs périodes")
- Anchor: [[WIDGET:SolvedExercise:option_pricing_crr:Exemple d'évaluation d'une option d'achat européenne dans le modèle CRR à une période]] (Type: "SolvedExercise", ID: "option_pricing_crr", Topic: "Exemple d'évaluation d'une option d'achat européenne dans le modèle CRR à une période")
- Anchor: [[WIDGET:Mermaid:concept_flow:Flux conceptuel des processus stochastiques discrets aux martingales et au modèle CRR]] (Type: "Mermaid", ID: "concept_flow", Topic: "Flux conceptuel des processus stochastiques discrets aux martingales et au modèle CRR")
- Anchor: [[WIDGET:CustomFigure:discrete_to_continuous:Illustration de la convergence des modèles discrets vers les modèles continus]] (Type: "CustomFigure", ID: "discrete_to_continuous", Topic: "Illustration de la convergence des modèles discrets vers les modèles continus")
- Anchor: [[WIDGET:Quote:musiela_rutkowski_martingales:Citation de Musiela et Rutkowski sur le rôle central des martingales en modélisation financière]] (Type: "Quote", ID: "musiela_rutkowski_martingales", Topic: "Citation de Musiela et Rutkowski sur le rôle central des martingales en modélisation financière")
