...
- Anchor: [[WIDGET:Mermaid:lesson_axes:Les trois axes majeurs de la politique économique moderne]] (Type: "Mermaid", ID: "lesson_axes", Topic: "Les trois axes majeurs de la politique économique moderne")
- Anchor: [[WIDGET:CustomFigure:phillips_curve_evolution:Évolution de la courbe de Phillips (courte et longue période)]] (Type: "CustomFigure", ID: "phillips_curve_evolution", Topic: "Évolution de la courbe de Phillips (courte et longue période)")
- Anchor: [[WIDGET:CustomFigure:environmental_policy_impacts:Impacts macroéconomiques des politiques environnementales sur l'inflation, la croissance et la compétitivité]] (Type: "CustomFigure", ID: "environmental_policy_impacts", Topic: "Impacts macroéconomiques des politiques environnementales sur l'inflation, la croissance et la compétitivité")
- Anchor: [[WIDGET:Mermaid:transition_energetique_flow:Schéma de la transition énergétique et ses leviers politiques]] (Type: "Mermaid", ID: "transition_energetique_flow", Topic: "Schéma de la transition énergétique et ses leviers politiques")
- Anchor: [[WIDGET:CustomFigure:policy_coordination_matrix:Interdépendance des politiques macroéconomiques]] (Type: "CustomFigure", ID: "policy_coordination_matrix", Topic: "Interdépendance des politiques macroéconomiques")
- Anchor: [[WIDGET:Video:global_cooperation_challenges:Les enjeux de la coopération internationale face aux biens publics mondiaux]] (Type: "Video", ID: "global_cooperation_challenges", Topic: "Les enjeux de la coopération internationale face aux biens publics mondiaux")
- Anchor: [[WIDGET:CustomFigure:integrated_policy_framework:Cadre d'une politique économique intégrée et résiliente]] (Type: "CustomFigure", ID: "integrated_policy_framework", Topic: "Cadre d'une politique économique intégrée et résiliente")
- Anchor: [[WIDGET:Mermaid:policy_integration_flow:Flux d'intégration des objectifs de politique économique]] (Type: "Mermaid", ID: "policy_integration_flow", Topic: "Flux d'intégration des objectifs de politique économique")
...
🚨 PREVIOUS CRITIQUE:
"The block contains several media components (Image and Video) that include a 'year' property within their 'props'. According to Critical Media Rule 5, Image and Video components MUST NOT contain a 'year' property. This field is forbidden and should be removed from all affected components.
Detailed errors:
- Field "interactiveComponents": The following components within 'interactiveComponents' violate Critical Media Rule 5 by including a 'year' property in their 'props': 'phillips_curve_evolution' (Image), 'environmental_policy_impacts' (Image), 'policy_coordination_matrix' (Image), 'global_cooperation_challenges' (Video), and 'integrated_policy_framework' (Image). The 'year' property must be removed from these media components."
