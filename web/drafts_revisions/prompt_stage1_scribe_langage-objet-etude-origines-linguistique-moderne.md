...
- **Academic Level**: "L1"
- **Lesson Title**: "Le langage comme objet d'étude: Aux origines de la linguistique moderne"
- **Lesson Slug**: "langage-objet-etude-origines-linguistique-moderne"
- **Target Language**: "FR"
- **Course Discipline**: "Général"
- **Epistemological Matrix**: "Sciences Humaines et Discursives"
- **Expected Cognitive Artifact**: "Analyse conceptuelle et historique"
- **Expected Guidelines / Technical Depth**: "Présentation des grandes écoles de pensée et des figures fondatrices de la linguistique, contextualisation des champs de la sémantique et de la phonétique dans l'histoire des sciences du langage."
