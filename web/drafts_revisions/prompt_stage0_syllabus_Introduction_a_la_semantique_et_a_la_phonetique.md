...
Your mission is to design the structure, lesson titles, and cognitive strategy of the course titled "Introduction à la sémantique et à la phonétique" for the level "beginner". You do not write the course content; you construct its pure, highly-adapted computational and educational backbone.
...
- **Course Title:** "Introduction à la sémantique et à la phonétique"
...
{
  "courseContext": {
    "discipline": "[Input discipline: 'Linguistics', translated to FR]",
