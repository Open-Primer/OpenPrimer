...
Lesson Description/Technical Depth: "Présentation des structures de données linéaires de base: tableaux (statiques et dynamiques) et listes chaînées (simples, doubles). Opérations fondamentales (insertion, suppression, accès). Comparaison des avantages et inconvénients."
