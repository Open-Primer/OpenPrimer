...
🚨 PREVIOUS CRITIQUE:
"Image components must not contain the 'year' property. The 'year' property was found in the 'industrial_revolution_factory' and 'ford_assembly_line' image components.
Detailed errors:
- Field "interactiveComponents[0].props.year": Image components must not contain the 'year' property. This field is automatically resolved downstream.
- Field "interactiveComponents[3].props.year": Image components must not contain the 'year' property. This field is automatically resolved downstream."
