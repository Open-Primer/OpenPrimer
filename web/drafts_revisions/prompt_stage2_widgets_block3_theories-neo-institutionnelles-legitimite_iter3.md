...
🚨 PREVIOUS CRITIQUE:
"The 'Image' components 'legitimite_concept' and 'impact_neo_institutionnel' contain the forbidden 'year' property. Image components must not contain 'url', 'wikipediaUrl', 'wikipediaLink', 'imageUrl', or 'year' properties as per critical media rules.
Detailed errors:
- Field "interactiveComponents": The 'Image' component with 'id: legitimite_concept' contains the forbidden 'year' property. Image components must not contain 'url', 'wikipediaUrl', 'wikipediaLink', 'imageUrl', or 'year' properties.
- Field "interactiveComponents": The 'Image' component with 'id: impact_neo_institutionnel' contains the forbidden 'year' property. Image components must not contain 'url', 'wikipediaUrl', 'wikipediaLink', 'imageUrl', or 'year' properties."
