  ...
  "interactiveComponents": [
    {
      ...
      "componentType": "Image",
      "sectionAnchor": "## La Grèce antique : un monde fragmenté",
      "props": {
        "description": "Carte géographique de la Grèce antique, mettant en évidence son relief montagneux, ses nombreuses îles et ses côtes découpées. Elle illustre la fragmentation naturelle du territoire en de multiples vallées et plaines isolées, propices à l'émergence de cités-États indépendantes plutôt qu'à un empire unifié. Les principales cités comme Athènes, Sparte, Corinthe et Thèbes sont localisées, ainsi que les mers environnantes (Égée, Ionienne).",
        "title": "Carte de la Grèce antique",
        "year": "Antiquité grecque classique (environ 500-323 av. J.-C.) ou période archaïque (environ 800-500 av. J.-C.) pour la formation des cités-États. La carte représente la géographie physique intemporelle de la région, mais son interprétation est pertinente pour ces périodes historiques."
      }
    }
  ]
}
