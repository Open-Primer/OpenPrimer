...
"""
... adéquatement les mouvements brusques et discontinus des prix, souvent appelés "sauts" (jumps). Ces sauts sont des changements de prix soudains et importants qui se produisent en réponse à des événements imprévus (annonces économiques, catastrophes naturelles, crises politiques, etc.) et qui sont responsables des "queues épaisses" (fat tails) observées dans la distribution des rendements des actifs [[WIDGET:Reference:5]]. Les modèles à sauts sont conçus spécifiquement pour intégrer ces mouvements discontinus.
