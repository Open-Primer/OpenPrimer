---
title: « Le langage humain : une approche plurielle et ses objets d'étude »
subject: « Introduction à la sémantique et à la phonétique »
level: « L1 »
module: « Le langage humain : une approche plurielle et ses objets d'étude »
order: 1
---

<Prerequisites itemsBase64="W10=" />

<DiagnosticQuiz question="Selon Ferdinand de Saussure, quelle est la distinction fondamentale entre la 'langue' et la 'parole'?" options="La langue est l'acte individuel d'utilisation, la parole est le système social.|||La langue est le système social abstrait, la parole est l'acte individuel d'utilisation.|||La langue est la faculté universelle, la parole est le système social.|||La langue est l'évolution historique, la parole est l'état actuel." correctIndex="1" targetSectionId="1.1.-Définitions-et-Distinctions-Langage-Langue-Parole" sectionTitle="1.1. Définitions et Distinctions : Langage, Langue, Parole" />
...
<CustomFigure src="https://example.com/language_abstract.jpg" alt="Abstract representation of human communication and language" caption="Figure 1: La Complexité du Langage Humain - Illustration abstraite symbolisant les multiples facettes et interconnexions du langage humain, incluant la communication, la pensée et la culture. Source: AI-generated" fallbackText="" fallbackUrl=""  unresolved={true}/>

<Objectives>
  <Knowledge>
    <ul className="list-disc pl-4 space-y-1">
      <li>analyser les concepts de langage, langue et parole selon Ferdinand de Saussure.</li>
      <li>analyser les six fonctions du langage selon Roman Jakobson.</li>
      <li>Évaluer les étapes clés de l'émergence de la linguistique comme science.</li>
      <li>analyser les principales dichotomies saussuriennes (langue/parole, synchronie/diachronie, signifiant/signifié).</li>
      <li>analyser les objets d'étude des principales branches de la linguistique (phonétique, phonologie, morphologie, syntaxe, sémantique, pragmatique, sociolinguistique, psycholinguistique).</li>
      <li>Évaluer les principes fondamentaux du structuralisme et du générativisme.</li>
    </ul>
  </Knowledge>
  <Skills>
    <ul className="list-disc pl-4 space-y-1">
      <li>analyser des exemples concrets pour distinguer langage, langue et parole.</li>
      <li>Appliquer le modèle de Jakobson pour analyser les fonctions dominantes d'un message.</li>
      <li>Évaluer la pertinence des différentes théories linguistiques face à des phénomènes langagiers.</li>
      <li>Créer une carte conceptuelle des interconnexions entre les branches de la linguistique.</li>
      <li>Distinguer les concepts clés de la sémantique (synonymie, antonymie, polysémie) et de la phonétique (lieu, mode d'articulation, voisement).</li>
    </ul>
  </Skills>
  <Attitudes>
    <ul className="list-disc pl-4 space-y-1">
      <li>Développer une curiosité intellectuelle pour la complexité du langage humain.</li>
      <li>Adopter une approche critique face aux différentes théories linguistiques.</li>
      <li>Apprécier la diversité des approches pour étudier le langage.</li>
    </ul>
  </Attitudes>
</Objectives>
...
<CustomFigure src="https://upload.wikimedia.org/wikipedia/commons/6/6b/TSA_picture.jpg" alt="Language processing in the brain" caption="Figure 5: Aires Cérébrales Impliquées dans le Traitement du Langage - Cette illustration schématique du cerveau humain met en évidence les principales régions corticales associées aux fonctions linguistiques, notamment l'aire de Broca (production du langage) et l'aire de Wernicke (compréhension du langage). Source: Adapté de modèles neuroscientifiques standards." fallbackText="" fallbackUrl="" />
...
<CustomFigure src="https://example.com/knowledge_interconnectedness.jpg" alt="Conceptual illustration of knowledge and interconnectedness" caption="Figure 8: L'Interconnexion des Concepts Linguistiques - Une illustration conceptuelle représentant la nature interconnectée des différentes branches et théories linguistiques, symbolisant l'expansion et l'intégration des connaissances. Source: AI-generated" fallbackText="" fallbackUrl=""  unresolved={true}/>



<WhatsNext itemsBase64="W10=" />
### Glossaire
<References itemsBase64="" />

- **Diachronie** : L'étude de l'évolution d'une langue à travers le temps.
- **Générativisme** : Théorie linguistique, principalement développée par Noam Chomsky, postulant l'existence d'une grammaire universelle innée qui sous-tend l'acquisition et l'utilisation du langage.
- **Langage** : Faculté humaine universelle et innée de communiquer au moyen d'un système de signes.
- **Langue** : Système de signes conventionnels et arbitraires, socialement institué et partagé par une communauté donnée.
- **Morphème** : La plus petite unité de sens dans une langue, qui peut être un mot, un préfixe ou un suffixe (ex: 'in-', 'croy-', '-able').
- **Parole** : Acte individuel d'utilisation de la langue, manifestation concrète et éphémère du système linguistique.
- **Phonème** : La plus petite unité sonore distinctive dans une langue, capable de différencier deux mots (ex: /p/ et /b/ en français).
- **Phonétique** : Étude des sons du langage dans leur réalité physique (production, transmission et perception), indépendamment de leur fonction distinctive.
- **Sémantique** : Branche de la linguistique qui étudie le sens des mots, des phrases et des énoncés.
- **Signifiant** : L'image acoustique ou la forme matérielle d'un signe linguistique (ex: la suite de sons [aʁbʁ]).
- **Signifié** : Le concept ou l'idée associée au signifiant d'un signe linguistique (ex: l'idée d'un arbre).
- **Structuralisme** : Courant linguistique, initié par Saussure, qui considère la langue comme un système autonome de signes interdépendants où chaque élément tire sa valeur de ses relations avec les autres.
- **Synchronie** : L'étude d'une langue à un moment donné de son histoire, sans prendre en compte son évolution.
