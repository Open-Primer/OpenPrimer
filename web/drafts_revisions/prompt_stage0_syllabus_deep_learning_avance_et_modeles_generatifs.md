...
Your mission is to design the structure, lesson titles, and cognitive strategy of the course titled "Deep Learning avancé et modèles génératifs" for the level "Master 2nd Year (M2)". You do not write the course content; you construct its pure, highly-adapted computational and educational backbone.
...
- **Course Title:** "Deep Learning avancé et modèles génératifs"
- **Target Level:** "Master 2nd Year (M2)"
- **Discipline:** "General"
- **Hourly Volume:** "15h"
- **Target Language:** "fr"
