---
title: « Le Sens en Contexte : Sémantique Frasale et Pragmatique »
subject: « Introduction à la sémantique et à la phonétique »
level: « L1 »
module: « Le Sens en Contexte : Sémantique Frasale et Pragmatique »
order: 5
---

<Prerequisites itemsBase64="W10=" />

<DiagnosticQuiz question="Quelle est la principale distinction entre la sémantique et la pragmatique ?" options="La sémantique étudie le sens des mots, tandis que la pragmatique étudie le sens des phrases.|||La sémantique se concentre sur le sens littéral et conventionnel des expressions linguistiques, tandis que la pragmatique s'intéresse au sens en contexte et à l'intention du locuteur.|||La sémantique analyse la structure grammaticale, alors que la pragmatique examine la phonologie.|||La sémantique est une branche de la philosophie, et la pragmatique est une branche de la psychologie." correctIndex="1" targetSectionId="introduction-a-la-pragmatique-le-sens-en-usage-les-actes-de-langage-et-le-contexte" sectionTitle="Introduction à la Pragmatique : Le Sens en Usage, les Actes de Langage et le Contexte" />
...
<Objectives>
  <Knowledge>
    <ul className="list-disc pl-4 space-y-1">
      <li>analyser le principe de compositionnalité et ses limites dans l'analyse du sens frasal.</li>
      <li>Distinguer clairement la sémantique de la pragmatique et leurs domaines d'étude respectifs.</li>
      <li>Classifier les différents types d'actes de langage (locutoire, illocutoire, perlocutoire) et leurs catégories (assertifs, directifs, commissifs, expressifs, déclaratifs).</li>
      <li>Interpréter le Principe de Coopération de Grice et ses quatre maximes conversationnelles.</li>
      <li>analyser le concept d'implicature conversationnelle et son rôle dans la communication inférée.</li>
      <li>Évaluer les fondements de la Théorie de la Pertinence de Sperber et Wilson comme alternative aux maximes de Grice.</li>
    </ul>
  </Knowledge>
  <Skills>
    <ul className="list-disc pl-4 space-y-1">
      <li>analyser des phrases complexes pour en dériver le sens littéral en appliquant le principe de compositionnalité.</li>
      <li>Évaluer les ambiguïtés lexicales et syntaxiques dans des énoncés et proposer des interprétations alternatives.</li>
      <li>Identifier la force illocutoire d'un énoncé donné et classer les actes de langage correspondants.</li>
      <li>Calculer des implicatures conversationnelles en identifiant les maximes de Grice exploitées ou violées.</li>
      <li>Appliquer les principes de la Théorie de la Pertinence pour expliquer l'interprétation du sens en contexte.</li>
      <li>Créer des messages nuancés en exploitant délibérément les implicatures pour communiquer au-delà du sens explicite.</li>
    </ul>
  </Skills>
  <Attitudes>
    <ul className="list-disc pl-4 space-y-1">
      <li>Développer une appréciation critique de la complexité du sens linguistique au-delà de la signification littérale.</li>
      <li>Adopter une approche réflexive face aux interactions communicatives, en reconnaissant l'importance du contexte et des intentions.</li>
      <li>Cultiver une curiosité pour les mécanismes implicites de la communication humaine et leur impact sur la compréhension mutuelle.</li>
    </ul>
  </Attitudes>
</Objectives>
...
Grice a postulé que les échanges conversationnels ne sont pas une succession aléatoire de remarques décousues, mais plutôt des efforts concertés et rationnels de coopération. Il a formulé le <ConceptLink name="Principe_de_coopération" lang="fr" description="Principe pragmatique selon lequel les participants à une conversation s'attendent à ce que chaque contribution soit pertinente, informative, véridique et claire, en vue d'un objectif commun." unresolved={true}>Principe de Coopération</ConceptLink> :
...
L'une des théories les plus influentes et les plus développées post-Grice est la <ConceptLink name="Théorie_de_la_pertinence" lang="fr" description="Approche pragmatique qui explique la communication comme un processus de reconnaissance d'intentions, guidé par le principe de pertinence, où l'auditeur cherche à maximiser les effets cognitifs pour un coût de traitement minimal." unresolved={true}>théorie de la pertinence</ConceptLink>, élaborée par les linguistes et psychologues cognitifs <RealPerson name="Dan_Sperber" lang="fr" bio="Linguiste et anthropologue français, co-fondateur de la théorie de la pertinence, qui propose une approche cognitive de la communication." unresolved={true}>Dan Sperber</RealPerson> et <RealPerson name="Deirdre_Wilson" lang="fr" bio="Linguiste britannique, co-fondatrice de la théorie de la pertinence, une théorie pragmatique influente." unresolved={true}>Deirdre Wilson</RealPerson> [6](#ref-6). Cette théorie propose une approche plus unifiée et cognitivement fondée de la communication, cherchant à remplacer les multiples maximes de Grice par un unique et puissant principe de pertinence.
...
### Glossaire
<References itemsBase64="" />

- **Acte illocutoire** : L'acte accompli par le locuteur en disant quelque chose, représentant son intention communicative (ex: promettre, ordonner).
- **Implicature conversationnelle** : Sens implicite communiqué par un locuteur sans être explicitement dit, que l'auditeur peut inférer en supposant que le locuteur respecte ou exploite le principe de coopération et ses maximes.
- **Pragmatique** : Branche de la linguistique qui étudie l'usage du langage en contexte, en se focalisant sur le sens communiqué par le locuteur et interprété par l'auditeur, au-delà du sens littéral.
- **Principe de compositionnalité** : Principe fondamental selon lequel le sens d'une expression linguistique complexe est entièrement déterminé par le sens de ses parties et par la manière dont ces parties sont combinées syntaxiquement.
