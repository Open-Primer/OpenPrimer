...
- Anchor: [[WIDGET:ConceptLink:politique_economique:politique économique]] (Type: "ConceptLink", ID: "politique_economique", Topic: "politique économique")
- Anchor: [[WIDGET:Glossary:modelisation_macroeconomique:modélisation macroéconomique]] (Type: "Glossary", ID: "modelisation_macroeconomique", Topic: "modélisation macroéconomique")
- Anchor: [[WIDGET:RealPerson:john_hicks:John Hicks]] (Type: "RealPerson", ID: "john_hicks", Topic: "John Hicks")
- Anchor: [[WIDGET:RealPerson:alvin_hansen:Alvin Hansen]] (Type: "RealPerson", ID: "alvin_hansen", Topic: "Alvin Hansen")
...
- Anchor: [[WIDGET:RealPerson:robert_solow:Robert Solow]] (Type: "RealPerson", ID: "robert_solow", Topic: "Robert Solow")
- Anchor: [[WIDGET:RealPerson:paul_romer:Paul Romer]] (Type: "RealPerson", ID: "paul_romer", Topic: "Paul Romer")
...
- Anchor: [[WIDGET:Glossary:calibration:calibrage]] (Type: "Glossary", ID: "calibration", Topic: "calibrage")
...
- Anchor: [[WIDGET:ConceptLink:agents_heterogenes:agents hétérogènes]] (Type: "ConceptLink", ID: "agents_heterogenes", Topic: "agents hétérogènes")
- Anchor: [[WIDGET:RealPerson:thomas_piketty:Thomas Piketty]] (Type: "RealPerson", ID: "thomas_piketty", Topic: "Thomas Piketty")
- Anchor: [[WIDGET:Glossary:macroeconomie_comportementale:macroéconomie comportementale]] (Type: "Glossary", ID: "macroeconomie_comportementale", Topic: "macroéconomie comportementale")
- Anchor: [[WIDGET:ConceptLink:modelisation_macro:modélisation macroéconomique]] (Type: "ConceptLink", ID: "modelisation_macro", Topic: "modélisation macroéconomique")
...
🚨 PREVIOUS CRITIQUE:
"The 'year' property for 'ConceptLink' and 'Glossary' components should be 'null' or omitted, as per the instructions for non-applicable properties. The current values 'N/A (concept)' and 'N/A (glossary term)' are considered template values or draft markers and violate the rule against placeholders.
Detailed errors:
- Field "interactiveComponents": The 'year' property in the 'politique_economique' (ConceptLink) and 'modelisation_macroeconomique' (Glossary) components contains descriptive text ('N/A (concept)', 'N/A (glossary term)') instead of being 'null' or omitted. For properties that do not require a value or are non-applicable, they must be explicitly 'null' or entirely absent, not filled with explanatory text."
