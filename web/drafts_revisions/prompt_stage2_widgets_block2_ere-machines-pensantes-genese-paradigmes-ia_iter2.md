...
🚨 PREVIOUS CRITIQUE:
"The 'interactiveComponents' array contains duplicate 'id' values. Each interactive component must have a unique 'id' to ensure proper functionality and referencing.
Detailed errors:
- Field "interactiveComponents": The 'id' 'ia_definition' is duplicated within the 'interactiveComponents' array. All 'id' values must be unique."
