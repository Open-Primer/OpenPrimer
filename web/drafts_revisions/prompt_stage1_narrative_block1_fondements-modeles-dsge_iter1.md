...
* Heading: "## Introduction aux modèles DSGE"
  Instructions: "Présenter l'importance des modèles DSGE en macroéconomie moderne, leur rôle dans l'analyse des politiques économiques, et les objectifs d'apprentissage de cette leçon."
* Heading: "## Les fondements microéconomiques: Agents représentatifs et optimisation intertemporelle"
  Instructions: "Expliquer le concept d'agent représentatif (ménage, firme) et leur problème d'optimisation intertemporelle sous incertitude. Aborder les fonctions d'utilité et de production typiques utilisées dans ces modèles."
...
- Lesson Title: "Fondements des modèles d'équilibre général dynamique stochastique (DSGE)"
- Discipline: "Économie"
- Target Language: "FR"
