...
* Heading: "## Introduction au Mouvement Brownien et à l'Intégrale d'Itô"
  Instructions: "Présenter l'importance du mouvement brownien et de l'intégrale d'Itô en finance quantitative, notamment pour la modélisation des prix d'actifs. Expliquer brièvement les objectifs du cours et son positionnement dans le programme de Master 1."
* Heading: "## Le Mouvement Brownien: Construction et Propriétés Fondamentales"
  Instructions: "Décrire la construction rigoureuse du mouvement brownien (définition par les propriétés des accroissements indépendants et stationnaires, continuité des trajectoires, etc.). Détailler ses propriétés clés : accroissements gaussiens, trajectoires continues mais nulle part différentiables, variance proportionnelle au temps."
