...
* Heading: "## Introduction: Le miroir de l'algorithme"
  Instructions: "Présenter le concept de la récursivité comme une technique de résolution de problèmes où une fonction s'appelle elle-même. Expliquer l'importance de la récursivité en informatique et donner un aperçu des sujets qui seront abordés dans la leçon."
* Heading: "## Principes Fondamentaux de la Récursivité"
  Instructions: "Définir formellement la récursivité. Expliquer les deux composants essentiels: le cas de base (condition d'arrêt) et l'appel récursif (étape récursive). Utiliser des analogies simples pour illustrer le concept."
