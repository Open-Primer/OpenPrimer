...
Lesson Description/Technical Depth: "Définition de la récursivité, cas de base et appel récursif. Exemples classiques (factorielle, Fibonacci, tours de Hanoï). Conversion d'algorithmes itératifs en récursifs et vice-versa. Analyse des coûts."
