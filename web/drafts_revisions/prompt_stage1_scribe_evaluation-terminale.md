...
- **Expected Cognitive Artifact**: "Questions à choix multiples, exercices d'analyse phonétique (transcription, identification) et sémantique (relations de sens, interprétation d'énoncés), questions ouvertes de réflexion"
- **Expected Guidelines / Technical Depth**: "Évaluation sommative des connaissances et compétences acquises sur les fondements de la sémantique et de la phonétique."
