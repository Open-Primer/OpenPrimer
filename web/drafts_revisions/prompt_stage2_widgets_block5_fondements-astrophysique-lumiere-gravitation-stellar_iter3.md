...
🚨 PREVIOUS CRITIQUE:
"The block contains incomplete fields within an Image component. The 'url', 'wikipediaLink', and 'wikipediaUrl' properties are empty, which violates the requirement for all fields to be fully populated with real, high-quality content.
Detailed errors:
- Field "interactiveComponents": The Image component with id 'spectre_corps_noir' has empty 'url', 'wikipediaLink', and 'wikipediaUrl' properties in its 'props'. These fields must be populated with valid URLs."
