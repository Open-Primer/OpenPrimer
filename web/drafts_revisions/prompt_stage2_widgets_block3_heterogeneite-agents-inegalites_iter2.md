...
- Anchor: [[WIDGET:Mermaid:macro_evolution:Évolution des paradigmes en macroéconomie face à l'hétérogénéité]] (Type: "Mermaid", ID: "macro_evolution", Topic: "Évolution des paradigmes en macroéconomie face à l'hétérogénéité")
- Anchor: [[WIDGET:CustomFigure:gini_coefficient_interpretation:Interprétation visuelle du coefficient de Gini]] (Type: "CustomFigure", ID: "gini_coefficient_interpretation", Topic: "Interprétation visuelle du coefficient de Gini")
- Anchor: [[WIDGET:Image:lorenz_curve:Représentation graphique de la courbe de Lorenz et de la ligne d'égalité parfaite]] (Type: "Image", ID: "lorenz_curve", Topic: "Représentation graphique de la courbe de Lorenz et de la ligne d'égalité parfaite")
- Anchor: [[WIDGET:CustomFigure:pmc_distribution:Distribution stylisée de la propension marginale à consommer en fonction du revenu]] (Type: "CustomFigure", ID: "pmc_distribution", Topic: "Distribution stylisée de la propension marginale à consommer en fonction du revenu")
- Anchor: [[WIDGET:Mermaid:heterogeneous_monetary_policy:Canaux de transmission hétérogènes de la politique monétaire]] (Type: "Mermaid", ID: "heterogeneous_monetary_policy", Topic: "Canaux de transmission hétérogènes de la politique monétaire")
- Anchor: [[WIDGET:Quote:keynes_consumption:Citation de John Maynard Keynes sur l'importance de la consommation dans l'économie]] (Type: "Quote", ID: "keynes_consumption", Topic: "Citation de John Maynard Keynes sur l'importance de la consommation dans l'économie")
- Anchor: [[WIDGET:CustomFigure:impact_heterogeneite:Impact de l'hétérogénéité sur les agrégats macroéconomiques]] (Type: "CustomFigure", ID: "impact_heterogeneite", Topic: "Impact de l'hétérogénéité sur les agrégats macroéconomiques")
- Anchor: [[WIDGET:Mermaid:defis_politiques_heterogeneite:Défis pour les décideurs politiques face à l'hétérogénéité]] (Type: "Mermaid", ID: "defis_politiques_heterogeneite", Topic: "Défis pour les décideurs politiques face à l'hétérogénéité")
...
🚨 PREVIOUS CRITIQUE:
"The block contains an Image component with a forbidden 'year' property. Image components must not contain 'year', 'url', 'wikipediaUrl', 'wikipediaLink', or 'imageUrl' properties as these are resolved automatically downstream.
Detailed errors:
- Field "interactiveComponents[2].props.year": The 'lorenz_curve' Image component (at index 2 in 'interactiveComponents') includes a 'year' property, which is forbidden for Image components. Image components should not contain 'year', 'url', 'wikipediaUrl', 'wikipediaLink', or 'imageUrl' properties."
