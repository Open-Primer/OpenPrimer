...
Your mission is to design the structure, lesson titles, and cognitive strategy of the course titled "Géographie physique et climatologie" for the level "University Year 3 / Bachelor 3rd Year (L3)". You do not write the course content; you construct its pure, highly-adapted computational and educational backbone.
...
- **Course Title:** "Géographie physique et climatologie"
- **Target Level:** "University Year 3 / Bachelor 3rd Year (L3)"
...
{
  "courseContext": {
    "discipline": "[Input discipline: 'Geography', translated to FR]",
