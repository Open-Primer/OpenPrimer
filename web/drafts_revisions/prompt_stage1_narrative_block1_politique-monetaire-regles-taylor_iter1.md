...
* Heading: "## Introduction à la Politique Monétaire Avancée"
  Instructions: "Présenter les objectifs de la politique monétaire dans un cadre macroéconomique avancé (stabilité des prix, croissance, emploi). Introduire la nécessité d'une analyse plus fine des mécanismes de transmission et des défis liés aux rigidités nominales."
* Heading: "## Rigidité des Prix et Salaires : Fondements et Conséquences"
  Instructions: "Expliquer les différentes sources de rigidité des prix et des salaires (contrats, coûts de menu, information imparfaite). Analyser comment ces rigidités affectent l'efficacité de la politique monétaire et la transmission des chocs."
