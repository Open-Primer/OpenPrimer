...
* Heading: "## L'Intégrale d'Itô: Définition et Propriétés Clés"
  Instructions: "Introduire la nécessité de l'intégrale d'Itô pour les processus stochastiques non différentiables. Définir l'intégrale d'Itô pour des processus simples (processus étagés) puis étendre la définition. Expliquer ses propriétés fondamentales, en insistant sur la différence avec l'intégrale de Riemann-Stieltjes."
* Heading: "## Le Lemme d'Itô et Premières Applications"
  Instructions: "Présenter le Lemme d'Itô comme un outil fondamental pour la différentiation des fonctions de processus d'Itô. Illustrer son application à des exemples simples pertinents pour la finance quantitative, comme la dérivation du modèle de Black-Scholes pour le prix d'une option."
...
- Lesson Title: "Mouvement Brownien et Intégrale d'Itô"
