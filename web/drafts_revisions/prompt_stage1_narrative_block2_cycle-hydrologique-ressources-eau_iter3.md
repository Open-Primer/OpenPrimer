...
* Heading: "## Bilan hydrique et dynamique des réserves d'eau douce"
  Instructions: "Analyser les bilans hydriques à différentes échelles (bassin versant, régionale, globale). Étudier les principales réserves d'eau douce: eaux de surface (lacs, rivières), eaux souterraines (aquifères, nappes phréatiques) et glaces. Mettre en évidence l'interconnexion de ces réservoirs."
* Heading: "## Enjeux contemporains et gestion des ressources en eau"
  Instructions: "Aborder les problématiques de la disponibilité et de la qualité de l'eau douce. Examiner l'impact des activités humaines (agriculture, industrie, urbanisation) et des changements climatiques sur le cycle hydrologique et les ressources en eau. Présenter les principes et les défis de la gestion intégrée de l'eau."
