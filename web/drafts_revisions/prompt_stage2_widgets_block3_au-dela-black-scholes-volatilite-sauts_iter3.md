...
- Anchor: [[WIDGET:Mermaid:model_evolution:Évolution des modèles de valorisation d'options, du BSM aux modèles avancés]] (Type: "Mermaid", ID: "model_evolution", Topic: "Évolution des modèles de valorisation d'options, du BSM aux modèles avancés")
- Anchor: [[WIDGET:CustomFigure:bsm_assumptions_vs_reality:Tableau comparatif des hypothèses du modèle de Black-Scholes et des réalités du marché]] (Type: "CustomFigure", ID: "bsm_assumptions_vs_reality", Topic: "Tableau comparatif des hypothèses du modèle de Black-Scholes et des réalités du marché")
- Anchor: [[WIDGET:Image:volatility_smile_example:Exemple graphique d'un smile de volatilité observé sur le marché des options]] (Type: "Image", ID: "volatility_smile_example", Topic: "Exemple graphique d'un smile de volatilité observé sur le marché des options")
- Anchor: [[WIDGET:CustomFigure:heston_sdes:Équations différentielles stochastiques du modèlede Heston pour le prix de l'actif et sa variance]] (Type: "CustomFigure", ID: "heston_sdes", Topic: "Équations différentielles stochastiques du modèlede Heston pour le prix de l'actif et sa variance")
- Anchor: [[WIDGET:Mermaid:heston_advantages_disadvantages:Diagramme des avantages et des inconvénients du modèlede Heston]] (Type: "Mermaid", ID: "heston_advantages_disadvantages", Topic: "Diagramme des avantages et des inconvénients du modèlede Heston")
- Anchor: [[WIDGET:CustomFigure:jump_diffusion_path:Illustration d'une trajectoire de prix d'actif avec des sauts (modèle de diffusion-sauts)]] (Type: "CustomFigure", ID: "jump_diffusion_path", Topic: "Illustration d'une trajectoire de prix d'actif avec des sauts (modèle de diffusion-sauts)")
- Anchor: [[WIDGET:Quiz:jump_models_quiz:Quiz sur les modèles à sauts et leurs applications]] (Type: "Quiz", ID: "jump_models_quiz", Topic: "Quiz sur les modèles à sauts et leurs applications")
- Anchor: [[WIDGET:Mermaid:model_comparison_flowchart:Diagramme comparatif des modèles de valorisation d'options (Black-Scholes, Heston, Sauts)]] (Type: "Mermaid", ID: "model_comparison_flowchart", Topic: "Diagramme comparatif des modèles de valorisation d'options (Black-Scholes, Heston, Sauts)")
- Anchor: [[WIDGET:CustomFigure:model_complexity_tradeoff:Illustration du compromis entre la complexité du modèl'et sa capacité à capturer les réalités du marché]] (Type: "CustomFigure", ID: "model_complexity_tradeoff", Topic: "Illustration du compromis entre la complexité du modèl'et sa capacité à capturer les réalités du marché")
...
🚨 PREVIOUS CRITIQUE:
"All Image components contain a 'year' property within their 'props' object, which is explicitly forbidden by the critical media rules. The 'year' property must be removed from all Image components.
Detailed errors:
- Field "interactiveComponents[1].props.year": Image components must NOT contain a 'year' property in their 'props'. This field is forbidden and must be removed.
- Field "interactiveComponents[2].props.year": Image components must NOT contain a 'year' property in their 'props'. This field is forbidden and must be removed.
- Field "interactiveComponents[3].props.year": Image components must NOT contain a 'year' property in their 'props'. This field is forbidden and must be removed.
- Field "interactiveComponents[5].props.year": Image components must NOT contain a 'year' property in their 'props'. This field is forbidden and must be removed.
- Field "interactiveComponents[8].props.year": Image components must NOT contain a 'year' property in their 'props'. This field is forbidden and must be removed."
