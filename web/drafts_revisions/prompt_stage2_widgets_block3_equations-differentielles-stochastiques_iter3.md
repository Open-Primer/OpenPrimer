...
🚨 PREVIOUS CRITIQUE:
"Some Image components contain the forbidden 'year' property. This property must be removed from all Image components.
Detailed errors:
- Field "interactiveComponents": The following Image components contain the forbidden 'year' property in their 'props': 'brownian_motion_path', 'eds_linear_example', and 'jump_diffusion_vs_gbm'. The 'year' property must be removed from all Image components as per critical media rules."
