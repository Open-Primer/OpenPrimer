...
* Heading: "## Introduction : Aux sources de la civilisation grecque"
  Instructions: "Cette section introduira la Grèce antique comme le berceau d'une civilisation riche et influente, posant les bases de la découverte de ses contributions majeures dans les arts et la pensée."
* Heading: "## Le Théâtre grec : Miroir de la société et de l'âme"
  Instructions: "Cette section explorera les origines et l'importance du théâtre dans la vie grecque, en présentant les genres principaux (tragédie, comédie) et des exemples d'auteurs et d'œuvres marquantes."
