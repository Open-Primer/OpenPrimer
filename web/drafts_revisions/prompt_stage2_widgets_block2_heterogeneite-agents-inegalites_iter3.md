...
🚨 PREVIOUS CRITIQUE:
"The list of interactive components contains a duplicate entry for "Thomas Piketty". Each interactive component should be unique.
Detailed errors:
- Field "interactiveComponents": The interactiveComponents array contains duplicate entries for "Thomas Piketty" (ids "thomas_piketty" and "piketty_thomas"). Please remove one of the duplicate entries to ensure uniqueness."
