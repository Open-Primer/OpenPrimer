...
* Heading: "## Introduction aux Changements Climatiques"
  Instructions: "Présenter le contexte général du changement climatique, sa définition, son importance en géographie physique et climatologie, et un aperçu des thèmes abordés dans la leçon."
* Heading: "## Observations et Preuves Scientifiques du Changement Climatique"
  Instructions: "Détailler les indicateurs clés du changement climatique (températures, niveau marin, événements extrêmes, etc.) et présenter les preuves scientifiques de son origine anthropique, en s'appuyant sur les rapports du GIEC."
