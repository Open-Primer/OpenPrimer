...
* Heading: "## Introduction aux Cycles Économiques Réels et Chocs Stochastiques"
  Instructions: "Présenter le concept des cycles économiques réels (RBC) comme une approche majeure pour comprendre les fluctuations macroéconomiques. Définir les chocs stochastiques comme moteurs de ces cycles et situer l'importance de leur étude dans l'analyse macroéconomique moderne. Énoncer les objectifs du cours."
* Heading: "## Les Fondements Théoriques des Modèles de Cycles Économiques Réels (RBC)"
  Instructions: "Expliquer les hypothèses clés des modèles RBC (agents rationnels, marchés concurrentiels, chocs de productivité). Décrire le mécanisme de propagation des chocs et le rôle de l'offre agrégée. Présenter un modèle RBC simple (par exemple, un modèle de base avec chocs technologiques) et ses implications."
