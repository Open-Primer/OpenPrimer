...
🚨 PREVIOUS CRITIQUE:
"The 'id' property for components within the 'interactiveComponents' array must be unique. Duplicate IDs were found for 'rationalisation' and 'frederick_taylor'. Each interactive component must have a distinct identifier.
Detailed errors:
- Field "interactiveComponents": The 'interactiveComponents' array contains elements with non-unique 'id' values. Specifically, 'rationalisation' appears multiple times (at indices 0 and 6), and 'frederick_taylor' also appears multiple times (at indices 7 and 15). All 'id' values within this array must be unique."
