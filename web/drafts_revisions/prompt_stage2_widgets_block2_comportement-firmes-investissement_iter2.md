...
🚨 PREVIOUS CRITIQUE:
"The 'interactiveComponents' array contains duplicate 'id' values. Each component within this array must have a unique identifier. The IDs 'cout_usage_capital' and 'couts_ajustement' are each used more than once.
Detailed errors:
- Field "interactiveComponents": The 'interactiveComponents' array contains duplicate 'id' values. Specifically, 'cout_usage_capital' and 'couts_ajustement' are duplicated. Each component must have a unique 'id'."
