...
🚨 PREVIOUS CRITIQUE:
"The Image component with ID 'deep_learning_timeline' contains the forbidden 'year' property in its props. According to CRITICAL MEDIA RULES, Image components must not contain 'year' properties.
Detailed errors:
- Field "interactiveComponents": The Image component with ID 'deep_learning_timeline' includes the 'year' property in its props, which is forbidden for Image components. Remove the 'year' property."
