...
🚨 PREVIOUS CRITIQUE:
"The block contains an Image component with a forbidden 'year' property. Image components must not contain 'year' in their props.
Detailed errors:
- Field "interactiveComponents": The 'lorenz_curve' component (an Image type) includes a 'year' property in its 'props', which is forbidden for Image components. Remove the 'year' property from this component."
