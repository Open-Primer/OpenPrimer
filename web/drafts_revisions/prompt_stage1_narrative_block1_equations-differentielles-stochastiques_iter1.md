...
* Heading: "## Introduction aux Équations Différentielles Stochastiques"
  Instructions: "Présenter les Équations Différentielles Stochastiques (EDS) comme un outil fondamental en finance quantitative pour modéliser des phénomènes aléatoires. Expliquer pourquoi les modèles déterministes sont insuffisants pour les marchés financiers et introduire la notion de mouvement brownien comme source de stochasticité."
* Heading: "## Fondements Mathématiques et Définitions Clés des EDS"
  Instructions: "Revoir les concepts nécessaires à la compréhension des EDS, notamment l'intégrale d'Itô et le lemme d'Itô. Définir formellement une EDS, en expliquant ses composantes (terme de dérive, terme de diffusion) et leur interprétation économique et probabiliste."
