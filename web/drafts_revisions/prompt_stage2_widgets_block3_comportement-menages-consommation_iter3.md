...
🚨 PREVIOUS CRITIQUE:
"The 'year' property is present in the props of a Video component, which is forbidden by the critical media rules.
Detailed errors:
- Field "interactiveComponents": The Video component with id 'intertemporal_choice_r' contains the forbidden 'year' property in its 'props'. Video components must not contain 'year'."
