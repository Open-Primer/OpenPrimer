...
🚨 PREVIOUS CRITIQUE:
"Media components (Image, Video, Audio) must not contain certain properties in their 'props' object, as these are resolved downstream. Specifically, the 'year' property is forbidden for Image and Video components.
Detailed errors:
- Field "interactiveComponents": The 'Image' component with id 'modele_seci_nonaka' and the 'Video' component with id 'reseaux_innovation_ex' both contain the forbidden 'year' property in their 'props'. Image and Video components must not contain 'year', 'url', 'wikipediaUrl', 'wikipediaLink', 'imageUrl', 'id', 'provider', or 'unresolved' properties."
