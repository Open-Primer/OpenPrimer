...
🚨 PREVIOUS CRITIQUE:
"The 'log_normal_dist' Image component contains the forbidden 'year' property in its 'props'. Image components must not contain 'url', 'wikipediaUrl', 'wikipediaLink', 'imageUrl', or 'year' properties.
Detailed errors:
- Field "interactiveComponents": The 'log_normal_dist' Image component (id: 'log_normal_dist') includes the 'year' property in its 'props', which is forbidden for Image components. Remove the 'year' property from this component."
