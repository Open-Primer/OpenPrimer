...
- Anchor: [[WIDGET:Mermaid:course_evolution_timeline:Chronologie simplifiée de l'évolution de la finance stochastique]] (Type: "Mermaid", ID: "course_evolution_timeline", Topic: "Chronologie simplifiée de l'évolution de la finance stochastique")
- Anchor: [[WIDGET:Image:bachelier_thesis:Page de titre de la thèse de Louis Bachelier, « Théorie de la Spéculation » (1900)]] (Type: "Image", ID: "bachelier_thesis", Topic: "Page de titre de la thèse de Louis Bachelier, « Théorie de la Spéculation » (1900)")
- Anchor: [[WIDGET:Quote:bachelier_quote:Citation de Louis Bachelier sur l'imprévisibilité des marchés financiers]] (Type: "Quote", ID: "bachelier_quote", Topic: "Citation de Louis Bachelier sur l'imprévisibilité des marchés financiers")
- Anchor: [[WIDGET:Image:black_scholes_formula:La formule de Black-Scholes pour la valorisation d'une option d'achat européenne]] (Type: "Image", ID: "black_scholes_formula", Topic: "La formule de Black-Scholes pour la valorisation d'une option d'achat européenne")
- Anchor: [[WIDGET:Mermaid:bsm_impact:Impact révolutionnaire du modèle Black-Scholes-Merton]] (Type: "Mermaid", ID: "bsm_impact", Topic: "Impact révolutionnaire du modèle Black-Scholes-Merton")
- Anchor: [[WIDGET:Quote:merton_quote:Citation de Robert C. Merton sur l'importance du modèle Black-Scholes]] (Type: "Quote", ID: "merton_quote", Topic: "Citation de Robert C. Merton sur l'importance du modèle Black-Scholes")
- Anchor: [[WIDGET:CustomFigure:interest_rate_models_taxonomy:Taxonomie simplifiée des principaux modèles de taux d'intérêt]] (Type: "CustomFigure", ID: "interest_rate_models_taxonomy", Topic: "Taxonomie simplifiée des principaux modèles de taux d'intérêt")
- Anchor: [[WIDGET:Image:volatility_smile:Illustration d'un sourire de volatilité typique sur les marchés d'options]] (Type: "Image", ID: "volatility_smile", Topic: "Illustration d'un sourire de volatilité typique sur les marchés d'options")
- Anchor: [[WIDGET:Mermaid:model_evolution_post_bsm:Évolution des modèles stochastiques post-Black-Scholes et leurs applications]] (Type: "Mermaid", ID: "model_evolution_post_bsm", Topic: "Évolution des modèles stochastiques post-Black-Scholes et leurs applications")
- Anchor: [[WIDGET:Mermaid:future_challenges_finance:Interconnexion des défis et perspectives en finance stochastique]] (Type: "Mermaid", ID: "future_challenges_finance", Topic: "Interconnexion des défis et perspectives en finance stochastique")
- Anchor: [[WIDGET:Image:ai_in_finance:Illustration de l'intelligence artificielle et du Machine Learning dans la finance]] (Type: "Image", ID: "ai_in_finance", Topic: "Illustration de l'intelligence artificielle et du Machine Learning dans la finance")
...
🚨 PREVIOUS CRITIQUE:
"The widget block contains critical media rule violations. Specifically, two Image components include the forbidden 'year' property within their 'props' object. Image components must not contain 'url', 'wikipediaUrl', 'wikipediaLink', 'imageUrl', or 'year' properties, as these are resolved automatically downstream.
Detailed errors:
- Field "interactiveComponents": The 'interactiveComponents' array contains two Image components that violate critical media rules. The component with 'id': 'bachelier_thesis' and the component with 'id': 'black_scholes_formula' both include a 'year' property in their 'props' object. This property is strictly forbidden for Image components and must be removed."
