...
* Heading: "## La dynamique de la circulation océanique"
  Instructions: "Décrire les principaux types de courants océaniques (superficiels et profonds). Expliquer les forces qui les animent: vent, salinité, température (circulation thermohaline). Présenter les grandes boucles océaniques."
* Heading: "## Impact sur les zones climatiques et les phénomènes extrêmes"
  Instructions: "Analyser comment la circulation atmosphérique et océanique détermine la répartition des grandes zones climatiques mondiales. Expliquer la formation et la dynamique de phénomènes météorologiques extrêmes (cyclones, moussons, sécheresses)."
...
"""
... atitude Nord et Sud, l'air froid et dense redescend, formant les zones de haute pression subtropicales (anticyclones subtropicaux), caractérisées par un temps sec et ensoleillé (ex: déserts du Sahara, d'Arabie, d'Australie).
...
"The text contains multiple `[refX]` placeholders throughout the introduction, various sections, and the conclusion. These placeholders indicate missing references and that the content is not finalized. All `[refX]` placeholders must be replaced with actual citations or removed if no citation is intended, to ensure the text is complete and ready for use."
