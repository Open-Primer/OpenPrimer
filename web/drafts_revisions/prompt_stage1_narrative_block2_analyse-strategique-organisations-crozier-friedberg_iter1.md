...
* Heading: "## Zones d'Incertitude et Stratégies de Pouvoir"
  Instructions: "Détailler le concept central de 'zones d'incertitude' et son rôle dans la construction du pouvoir au sein des organisations. Expliquer comment les acteurs exploitent ces zones pour développer leur autonomie et influencer les décisions, en illustrant avec des exemples concrets."
* Heading: "## Dynamiques Stratégiques et Résistance au Changement"
  Instructions: "Analyser comment les stratégies des acteurs interagissent et forment des 'systèmes d'action concrets'. Aborder les mécanismes de résistance au changement et comment l'analyse stratégique permet de comprendre et potentiellement de gérer ces dynamiques pour initier des transformations organisationnelles."
...
- Lesson Title: "L'Analyse Stratégique des Organisations (Crozier & Friedberg)"
