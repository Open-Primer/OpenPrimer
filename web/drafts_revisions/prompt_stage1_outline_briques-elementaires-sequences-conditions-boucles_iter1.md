...
Lesson Description/Technical Depth: "Introduction aux structures de contrôle fondamentales: séquence d'instructions, structures conditionnelles (si-alors-sinon) et structures itératives (tant que, pour). Exercices de conception de petits algorithmes."
