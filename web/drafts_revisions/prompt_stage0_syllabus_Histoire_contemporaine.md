...
Your mission is to design the structure, lesson titles, and cognitive strategy of the course titled "Histoire contemporaine" for the level "University Year 1 / Bachelor 1st Year (L1)". You do not write the course content; you construct its pure, highly-adapted computational and educational backbone.
...
- **Course Title:** "Histoire contemporaine"
...
{
  "courseContext": {
    "discipline": "[Input discipline: 'History', translated to FR]",
