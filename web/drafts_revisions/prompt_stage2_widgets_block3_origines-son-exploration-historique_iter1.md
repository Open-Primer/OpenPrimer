...
- Anchor: [[WIDGET:Image:pythagorean_monochord:Représentation d'un monocorde, instrument attribué à Pythagore pour l'étude des rapports musicaux.]] (Type: "Image", ID: "pythagorean_monochord", Topic: "Représentation d'un monocorde, instrument attribué à Pythagore pour l'étude des rapports musicaux.")
- Anchor: [[WIDGET:Mermaid:timeline_ancient_acoustics:Chronologie des contributions majeures à l'acoustique durant l'Antiquité grecque.]] (Type: "Mermaid", ID: "timeline_ancient_acoustics", Topic: "Chronologie des contributions majeures à l'acoustique durant l'Antiquité grecque.")
- Anchor: [[WIDGET:Mermaid:renaissance_acoustics_timeline:Chronologie des avancées en acoustique de la Renaissance, mettant en lumière l'approche expérimentale.]] (Type: "Mermaid", ID: "renaissance_acoustics_timeline", Topic: "Chronologie des avancées en acoustique de la Renaissance, mettant en lumière l'approche expérimentale.")
- Anchor: [[WIDGET:Image:galileo_string_experiment:Illustration des expériences de Galilée sur la vibration des cordes, démontrant la relation entre longueur et hauteur.]] (Type: "Image", ID: "galileo_string_experiment", Topic: "Illustration des expériences de Galilée sur la vibration des cordes, démontrant la relation entre longueur et hauteur.")
- Anchor: [[WIDGET:CustomFigure:sound_propagation_diagram:Schéma illustrant la propagation du son comme une perturbation du milieu, montrant les zones de compression et de raréfaction.]] (Type: "CustomFigure", ID: "sound_propagation_diagram", Topic: "Schéma illustrant la propagation du son comme une perturbation du milieu, montrant les zones de compression et de raréfaction.")
- Anchor: [[WIDGET:Video:sound_wave_animation:Animation expliquant la vibration d'une source sonore et la propagation d'une onde sonore dans un milieu.]] (Type: "Video", ID: "sound_wave_animation", Topic: "Animation expliquant la vibration d'une source sonore et la propagation d'une onde sonore dans un milieu.")
- Anchor: [[WIDGET:CustomFigure:wave_equation_diagram:Illustration de l'équation d'onde classique, fondement de l'acoustique physique.]] (Type: "CustomFigure", ID: "wave_equation_diagram", Topic: "Illustration de l'équation d'onde classique, fondement de l'acoustique physique.")
- Anchor: [[WIDGET:Mermaid:acoustics_evolution_timeline:Chronologie simplifiée de l'évolution de l'acoustique, des origines à l'ère moderne, illustrant les contributions clés et les périodes charnières.]] (Type: "Mermaid", ID: "acoustics_evolution_timeline", Topic: "Chronologie simplifiée de l'évolution de l'acoustique, des origines à l'ère moderne, illustrant les contributions clés et les périodes charnières.")
