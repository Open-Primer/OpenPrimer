...
Your mission is to design the structure, lesson titles, and cognitive strategy of the course titled "Philosophie des sciences et épistémologie" for the level "University Year 1 / Bachelor 1st Year (L1)". You do not write the course content; you construct its pure, highly-adapted computational and educational backbone.
...
- **Course Title:** "Philosophie des sciences et épistémologie"
...
{
  "courseContext": {
    "discipline": "[Input discipline: 'Philosophy', translated to FR]",
