...
🚨 PREVIOUS CRITIQUE:
"Some Glossary components contain "year": "N/A" which should be "null" or omitted.
Detailed errors:
- Field "interactiveComponents": The 'year' property in Glossary components must be 'null' or omitted if not applicable, as per instructions. It currently contains the string 'N/A' for the following Glossary entries: 'paysage_organisationnel', 'economie_numerique', 'interdependance', 'co_entreprise', 'gig_economy', and 'controle_sans_hierarchie'."
