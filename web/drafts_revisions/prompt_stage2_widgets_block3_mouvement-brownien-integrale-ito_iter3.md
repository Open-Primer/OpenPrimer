...
- Anchor: [[WIDGET:Mermaid:course_objectives_flow:Diagramme des objectifs du cours et de son positionnement en M1]] (Type: "Mermaid", ID: "course_objectives_flow", Topic: "Diagramme des objectifs du cours et de son positionnement en M1")
- Anchor: [[WIDGET:Image:simulated_brownian_path:Exemple de trajectoire simulée d'un mouvement brownien standard]] (Type: "Image", ID: "simulated_brownian_path", Topic: "Exemple de trajectoire simulée d'un mouvement brownien standard")
- Anchor: [[WIDGET:CustomFigure:ito_vs_riemann:Illustration schématique de la différence entre les sommes d'Itô et de Riemann-Stieltjes pour un processus stochastique]] (Type: "CustomFigure", ID: "ito_vs_riemann", Topic: "Illustration schématique de la différence entre les sommes d'Itô et de Riemann-Stieltjes pour un processus stochastique")
- Anchor: [[WIDGET:Mermaid:ito_integral_concept:Diagramme conceptuel de l'intégrale d'Itô et ses propriétés clés]] (Type: "Mermaid", ID: "ito_integral_concept", Topic: "Diagramme conceptuel de l'intégrale d'Itô et ses propriétés clés")
- Anchor: [[WIDGET:SolvedExercise:ito_lemma_gbm:Démonstration de l'application du Lemme d'Itô au mouvement brownien géométrique pour obtenir $d(\ln S_t)$]] (Type: "SolvedExercise", ID: "ito_lemma_gbm", Topic: "Démonstration de l'application du Lemme d'Itô au mouvement brownien géométrique pour obtenir $d(\ln S_t)$")
- Anchor: [[WIDGET:Mermaid:concept_map_stochastic_finance:Carte conceptuelle des liens entre Mouvement Brownien, Intégrale d'Itô, Lemme d'Itô et les EDS en finance stochastique]] (Type: "Mermaid", ID: "concept_map_stochastic_finance", Topic: "Carte conceptuelle des liens entre Mouvement Brownien, Intégrale d'Itô, Lemme d'Itô et les EDS en finance stochastique")
- Anchor: [[WIDGET:CustomFigure:sde_simulation:Exemple de simulation de trajectoires d'une Équation Différentielle Stochastique]] (Type: "CustomFigure", ID: "sde_simulation", Topic: "Exemple de simulation de trajectoires d'une Équation Différentielle Stochastique")
...
🚨 PREVIOUS CRITIQUE:
"The block contains critical errors related to media component properties. Image components must not include the 'year' property, as specified in the critical media rules. This property was found in multiple image components.
Detailed errors:
- Field "interactiveComponents[1].props.year": Image components must NOT contain the 'year' property according to the critical media rules. This field should be removed.
- Field "interactiveComponents[2].props.year": Image components must NOT contain the 'year' property according to the critical media rules. This field should be removed.
- Field "interactiveComponents[6].props.year": Image components must NOT contain the 'year' property according to the critical media rules. This field should be removed."
