...
* Heading: "## Introduction à l'Analyse Stratégique des Organisations"
  Instructions: "Présenter le contexte de l'analyse stratégique des organisations, introduire Michel Crozier et Erhard Friedberg comme figures centrales, et expliquer la pertinence de leur approche pour comprendre les dynamiques de pouvoir et de décision au sein des organisations."
* Heading: "## La Théorie des Acteurs et des Systèmes : Concepts Clés"
  Instructions: "Expliquer les concepts fondamentaux de la théorie des acteurs et des systèmes développée par Crozier et Friedberg. Définir ce qu'est un acteur, un système d'action concret, et comment les individus construisent leurs stratégies dans un cadre organisationnel."
