...
- **Lesson Slug**: "the-quantum-revolution-from-bits-to-qubits"
- **Target Language**: "EN"
- **Course Discipline**: "Computer Science"
- **Epistemological Matrix**: "Applied Sciences / Engineering"
- **Expected Cognitive Artifact**: "Conceptual Diagram / Historical Timeline"
- **Expected Guidelines / Technical Depth**: "High-level overview of quantum mechanics principles and their computational implications, historical milestones, and the 'why' of quantum computing, assuming prior scientific literacy."
...
- ID: "CodeSandbox"
  Name: "JavaScript Code Sandbox" (Bac à sable de programmation JS)
  Description: "Lightweight online coding workspace with reactive JavaScript runtime and terminal console."
...
8. **Rich Multimedia Media Elements**:
   ...
   - AudioPlayer tags MUST specify a clear summary explanation, pronunciation guide, or key definition:
     - Format: `<AudioPlayer title="Prononciation et étymologie de la synapse" duration="1:15" />`
