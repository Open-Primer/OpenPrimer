...
* Heading: "## Introduction : Aux sources de l'Europe"
  Instructions: "Présenter l'objectif de la leçon, l'importance de la Grèce antique comme berceau de la civilisation européenne et les thèmes abordés : géographie, premières civilisations et mythes fondateurs."
* Heading: "## La Grèce antique : Un carrefour géographique et temporel"
  Instructions: "Décrire la géographie de la Grèce (montagnes, mer, îles), son influence sur le développement des sociétés et des échanges, et situer chronologiquement la période étudiée (de l'âge du bronze à l'émergence des cités)."
