...
- Anchor: [[WIDGET:Mermaid:timeline_macro_ruptures:Chronologie simplifiée des grandes ruptures de la pensée macroéconomique]] (Type: "Mermaid", ID: "timeline_macro_ruptures", Topic: "Chronologie simplifiée des grandes ruptures de la pensée macroéconomique")
- Anchor: [[WIDGET:Image:is_lm_model:Représentation graphique simplifiée du modèl'IS-LM]] (Type: "Image", ID: "is_lm_model", Topic: "Représentation graphique simplifiée du modèl'IS-LM")
- Anchor: [[WIDGET:CustomFigure:phillips_curve_critique:La courbe de Phillips à court et long terme, illustrant la critique monétariste]] (Type: "CustomFigure", ID: "phillips_curve_critique", Topic: "La courbe de Phillips à court et long terme, illustrant la critique monétariste")
- Anchor: [[WIDGET:CustomFigure:lucas_critique_diagram:Diagramme illustrant l'impact des anticipations rationnelles sur l'efficacité des politiques]] (Type: "CustomFigure", ID: "lucas_critique_diagram", Topic: "Diagramme illustrant l'impact des anticipations rationnelles sur l'efficacité des politiques")
- Anchor: [[WIDGET:Mermaid:evolution_macro_thought:Graphique d'évolution des idées macroéconomiques de la Nouvelle Macroéconomie Classique au Néo-Keynésianisme]] (Type: "Mermaid", ID: "evolution_macro_thought", Topic: "Graphique d'évolution des idées macroéconomiques de la Nouvelle Macroéconomie Classique au Néo-Keynésianisme")
- Anchor: [[WIDGET:CustomFigure:dsge_limitations:Illustration des limites des modèles DSGE face à la crise financière]] (Type: "CustomFigure", ID: "dsge_limitations", Topic: "Illustration des limites des modèles DSGE face à la crise financière")
- Anchor: [[WIDGET:CustomFigure:evolution_macro_paradigms:Schéma de l'évolution des paradigmes macroéconomiques contemporains]] (Type: "CustomFigure", ID: "evolution_macro_paradigms", Topic: "Schéma de l'évolution des paradigmes macroéconomiques contemporains")
- Anchor: [[WIDGET:Mermaid:macro_future_challenges:Diagramme des défis et perspectives de la macroéconomie moderne]] (Type: "Mermaid", ID: "macro_future_challenges", Topic: "Diagramme des défis et perspectives de la macroéconomie moderne")
...
🚨 PREVIOUS CRITIQUE:
"The widget block contains several interactive components of type 'Image' and 'CustomFigure' that include forbidden properties. According to CRITICAL MEDIA RULES (Rule 5), 'Image' components and other media components like 'CustomFigure' MUST NOT contain 'url', 'wikipediaUrl', 'wikipediaLink', or 'year' properties within their 'props' object. These fields are automatically resolved downstream by the external-resource-resolver pipeline. Please remove these forbidden properties from the 'props' of the identified components.
Detailed errors:
- Field "interactiveComponents": The following components within 'interactiveComponents' contain forbidden properties:
- 'is_lm_model' (Image): Contains 'year' in its props.
- 'phillips_curve_critique' (CustomFigure): Contains 'url', 'wikipediaLink', 'wikipediaUrl', and 'year' in its props.
- 'lucas_critique_diagram' (CustomFigure): Contains 'url', 'wikipediaLink', 'wikipediaUrl', and 'year' in its props.
- 'dsge_limitations' (CustomFigure): Contains 'url', 'wikipediaLink', 'wikipediaUrl', and 'year' in its props.
- 'evolution_macro_paradigms' (CustomFigure): Contains 'url', 'wikipediaLink', 'wikipediaUrl', and 'year' in its props.
These properties must be removed as they are automatically handled by the system and their presence is an error."
