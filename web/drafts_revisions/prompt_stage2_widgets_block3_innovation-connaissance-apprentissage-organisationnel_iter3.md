...
- Anchor: [[WIDGET:CustomFigure:enjeux_socio_eco:Représentation des enjeux socio-économiques contemporains pour les organisations]] (Type: "CustomFigure", ID: "enjeux_socio_eco", Topic: "Représentation des enjeux socio-économiques contemporains pour les organisations")
- Anchor: [[WIDGET:Image:modele_seci_nonaka:Le modèle SECI de création de connaissance selon Nonaka et Takeuchi]] (Type: "Image", ID: "modele_seci_nonaka", Topic: "Le modèle SECI de création de connaissance selon Nonaka et Takeuchi")
- Anchor: [[WIDGET:Mermaid:lien_ico:Diagramme illustrant les liens entre Innovation, Connaissance et Apprentissage Organisationnel]] (Type: "Mermaid", ID: "lien_ico", Topic: "Diagramme illustrant les liens entre Innovation, Connaissance et Apprentissage Organisationnel")
- Anchor: [[WIDGET:CustomFigure:structure_innovation:Impact des structures organisationnelles sur l'apprentissage et l'innovation]] (Type: "CustomFigure", ID: "structure_innovation", Topic: "Impact des structures organisationnelles sur l'apprentissage et l'innovation")
- Anchor: [[WIDGET:Mermaid:facteurs_intra_org:Facteurs sociaux intra-organisationnels de l'apprentissage et de l'innovation]] (Type: "Mermaid", ID: "facteurs_intra_org", Topic: "Facteurs sociaux intra-organisationnels de l'apprentissage et de l'innovation")
- Anchor: [[WIDGET:CustomFigure:types_reseaux_innovation:Typologie des relations inter-organisationnelles pour l'innovation]] (Type: "CustomFigure", ID: "types_reseaux_innovation", Topic: "Typologie des relations inter-organisationnelles pour l'innovation")
- Anchor: [[WIDGET:Video:reseaux_innovation_ex:Exemple de réseau d'innovation ou de cluster]] (Type: "Video", ID: "reseaux_innovation_ex", Topic: "Exemple de réseau d'innovation ou de cluster")
- Anchor: [[WIDGET:CustomFigure:synthese_innovation_apprentissage:Interdépendance entre innovation, connaissance et apprentissage organisationnel]] (Type: "CustomFigure", ID: "synthese_innovation_apprentissage", Topic: "Interdépendance entre innovation, connaissance et apprentissage organisationnel")
- Anchor: [[WIDGET:Mermaid:defis_perspectives_innovation:Défis et perspectives pour l'innovation et l'apprentissage]] (Type: "Mermaid", ID: "defis_perspectives_innovation", Topic: "Défis et perspectives pour l'innovation et l'apprentissage")
...
🚨 PREVIOUS CRITIQUE:
"The widget block contains critical media rule violations. Specifically, 'year' properties are present in the 'props' of an Image component and a Video component, which are forbidden.
Detailed errors:
- Field "interactiveComponents": The 'interactiveComponents' array contains media components with forbidden properties. The Image component with id 'modele_seci_nonaka' includes a 'year' property in its 'props', which is not allowed for Image components. The Video component with id 'reseaux_innovation_ex' also includes a 'year' property in its 'props', which is forbidden for Video components. These properties are resolved automatically downstream and should not be present in the raw JSON."
