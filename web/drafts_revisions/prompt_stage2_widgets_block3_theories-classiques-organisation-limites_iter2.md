...
- Anchor: [[WIDGET:Image:industrial_revolution_factory:Usine de l'ère industrielle, symbole de la production de masse et de l'organisation du travail]] (Type: "Image", ID: "industrial_revolution_factory", Topic: "Usine de l'ère industrielle, symbole de la production de masse et de l'organisation du travail")
- Anchor: [[WIDGET:Quote:taylor_scientific_management:Citation de Frederick Winslow Taylor sur la nécessité de la direction scientifique pour l'efficacité industrielle]] (Type: "Quote", ID: "taylor_scientific_management", Topic: "Citation de Frederick Winslow Taylor sur la nécessité de la direction scientifique pour l'efficacité industrielle")
- Anchor: [[WIDGET:Mermaid:classical_theories_concept_map:Carte conceptuelle des trois piliers des théories classiques de l'organisation (Taylor, Fayol, Weber)]] (Type: "Mermaid", ID: "classical_theories_concept_map", Topic: "Carte conceptuelle des trois piliers des théories classiques de l'organisation (Taylor, Fayol, Weber)")
- Anchor: [[WIDGET:Image:ford_assembly_line:Chaîne de montage de Ford, illustrant les principes tayloriens de division du travail et de standardisation]] (Type: "Image", ID: "ford_assembly_line", Topic: "Chaîne de montage de Ford, illustrant les principes tayloriens de division du travail et de standardisation")
- Anchor: [[WIDGET:Mermaid:fayol_org_chart:Organigramme hiérarchique inspiré des principes de Fayol, montrant la structure pyramidale et la ligne d'autorité]] (Type: "Mermaid", ID: "fayol_org_chart", Topic: "Organigramme hiérarchique inspiré des principes de Fayol, montrant la structure pyramidale et la ligne d'autorité")
- Anchor: [[WIDGET:CustomFigure:mechanistic_org_metaphor:Métaphore de l'organisation comme machine, illustrant la vision mécaniste des théories classiques]] (Type: "CustomFigure", ID: "mechanistic_org_metaphor", Topic: "Métaphore de l'organisation comme machine, illustrant la vision mécaniste des théories classiques")
- Anchor: [[WIDGET:Mermaid:critiques_timeline:Chronologie simplifiée des principales critiques adressées aux théories classiques de l'organisation]] (Type: "Mermaid", ID: "critiques_timeline", Topic: "Chronologie simplifiée des principales critiques adressées aux théories classiques de l'organisation")
- Anchor: [[WIDGET:CustomFigure:evolution_org_theories:Diagramme illustrant l'évolution des théories organisationnelles, des approches classiques aux approches contemporaines intégratives]] (Type: "CustomFigure", ID: "evolution_org_theories", Topic: "Diagramme illustrant l'évolution des théories organisationnelles, des approches classiques aux approches contemporaines intégratives")
- Anchor: [[WIDGET:Mermaid:integration_modern_theories:Schéma illustrant l'intégration des principes classiques et des approches modernes pour une gestion organisationnelle efficace]] (Type: "Mermaid", ID: "integration_modern_theories", Topic: "Schéma illustrant l'intégration des principes classiques et des approches modernes pour une gestion organisationnelle efficace")
...
🚨 PREVIOUS CRITIQUE:
"The widget block contains Image components with forbidden 'year' properties, which violates the critical media rules. Image components must not contain 'year'.
Detailed errors:
- Field "interactiveComponents": The 'industrial_revolution_factory' and 'ford_assembly_line' Image components within 'interactiveComponents' include a 'year' property, which is explicitly forbidden for Image components according to critical media rules. Please remove the 'year' property from these components."
