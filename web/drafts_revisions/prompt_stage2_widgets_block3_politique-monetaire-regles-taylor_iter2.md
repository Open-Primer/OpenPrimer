...
- Anchor: [[WIDGET:Image:objectifs_politique_monetaire:Les objectifs fondamentaux de la politique monétaire]] (Type: "Image", ID: "objectifs_politique_monetaire", Topic: "Les objectifs fondamentaux de la politique monétaire")
- Anchor: [[WIDGET:Mermaid:flux_politique_monetaire:Schéma simplifié des mécanismes de transmission de la politique monétaire]] (Type: "Mermaid", ID: "flux_politique_monetaire", Topic: "Schéma simplifié des mécanismes de transmission de la politique monétaire")
- Anchor: [[WIDGET:CustomFigure:impact_rigidites_politique_monetaire:L'impact des rigidités nominales sur la transmission de la politique monétaire]] (Type: "CustomFigure", ID: "impact_rigidites_politique_monetaire", Topic: "L'impact des rigidités nominales sur la transmission de la politique monétaire")
- Anchor: [[WIDGET:CustomFigure:fonctions_banque_centrale:Les fonctions clés d'une banque centrale moderne, incluant l'émission, la régulation et la politique monétaire]] (Type: "CustomFigure", ID: "fonctions_banque_centrale", Topic: "Les fonctions clés d'une banque centrale moderne, incluant l'émission, la régulation et la politique monétaire")
- Anchor: [[WIDGET:Mermaid:instruments_politique_monetaire:Diagramme des instruments de politique monétaire (conventionnels et non conventionnels)]] (Type: "Mermaid", ID: "instruments_politique_monetaire", Topic: "Diagramme des instruments de politique monétaire (conventionnels et non conventionnels)")
- Anchor: [[WIDGET:CustomFigure:canaux_transmission_politique_monetaire:Schéma des principaux canaux de transmission de la politique monétaire à l'économie réelle]] (Type: "CustomFigure", ID: "canaux_transmission_politique_monetaire", Topic: "Schéma des principaux canaux de transmission de la politique monétaire à l'économie réelle")
- Anchor: [[WIDGET:Video:transmission_monetaire_explication:Vidéo explicative sur les mécanismes de transmission de la politique monétaire]] (Type: "Video", ID: "transmission_monetaire_explication", Topic: "Vidéo explicative sur les mécanismes de transmission de la politique monétaire")
- Anchor: [[WIDGET:CustomFigure:taylor_rule_formula:Formulation de la Règle de Taylor et ses composantes]] (Type: "CustomFigure", ID: "taylor_rule_formula", Topic: "Formulation de la Règle de Taylor et ses composantes")
- Anchor: [[WIDGET:Mermaid:taylor_rule_logic:Logique de décision de la Règle de Taylor]] (Type: "Mermaid", ID: "taylor_rule_logic", Topic: "Logique de décision de la Règle de Taylor")
- Anchor: [[WIDGET:Image:taylor_rule_historical_fit:Exemple d'application historique de la Règle de Taylor par la Réserve fédérale]] (Type: "Image", ID: "taylor_rule_historical_fit", Topic: "Exemple d'application historique de la Règle de Taylor par la Réserve fédérale")
...
🚨 PREVIOUS CRITIQUE:
"Several media components (Image and Video) contain a 'year' property within their 'props'. According to CRITICAL MEDIA RULES, Image and Video components MUST NOT contain a 'year' property. This field is forbidden in the raw widgets JSON for these component types.
Detailed errors:
- Field "interactiveComponents": The following components incorrectly include a 'year' property in their 'props': 'objectifs_politique_monetaire' (Image), 'impact_rigidites_politique_monetaire' (Image), 'fonctions_banque_centrale' (Image), 'canaux_transmission_politique_monetaire' (Image), 'transmission_monetaire_explication' (Video), 'taylor_rule_formula' (Image), and 'taylor_rule_historical_fit' (Image). Please remove the 'year' property from these media components."
