...
🚨 PREVIOUS CRITIQUE:
"The block contains an Image component (`is_lm_model`) that includes a forbidden 'year' property in its 'props'. Image components must not contain 'url', 'wikipediaUrl', 'wikipediaLink', 'imageUrl', or 'year' properties.
Detailed errors:
- Field "interactiveComponents": The 'is_lm_model' component, which is of type 'Image', contains the forbidden 'year' property in its 'props'. Image components must not contain 'url', 'wikipediaUrl', 'wikipediaLink', 'imageUrl', or 'year' properties. Please remove the 'year' property from this Image component."
