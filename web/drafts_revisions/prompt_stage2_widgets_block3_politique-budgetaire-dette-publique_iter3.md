...
🚨 PREVIOUS CRITIQUE:
"The widget block contains an Image component with a forbidden 'year' property. Image components must not contain 'year', 'url', 'wikipediaUrl', 'wikipediaLink', or 'imageUrl' properties as these are resolved automatically downstream.
Detailed errors:
- Field "interactiveComponents": The 'public_debt_evolution' Image component includes the forbidden 'year' property in its 'props'. Please remove this property."
