...
Sinon
  Afficher &quot;Faux&quot;
Fin Si«  options= »Vrai|||Faux|||Erreur de syntaxe|||Indéterminé«  correctIndex= »0«  targetSectionId= »introduction-sequences«  sectionTitle= »Introduction aux Séquences«  />
...
<Quiz durationLimit={900}>
    <Question q="Quelle est la caractéristique principale d'une séquence d'instructions en algorithmique ?" explanation="Une séquence d'instructions est un bloc d'opérations exécutées l'une après l'autre, dans l'ordre où elles sont écrites.">
  <Option text="Les instructions sont exécutées dans un ordre aléatoire." correct={false} />
  <Option text="Les instructions sont exécutées de manière conditionnelle." correct={false} />
  <Option text="Les instructions sont exécutées séquentiellement, de la première à la dernière." correct={true} />
  <Option text="Les instructions peuvent être répétées indéfiniment." correct={false} />
</Question>
    <Question q="Quel est le rôle d'une structure conditionnelle (par exemple, SI...ALORS...SINON) ?" explanation="Les structures conditionnelles permettent de contrôler le flux d'exécution d'un algorithme en fonction de la véracité d'une ou plusieurs conditions.">
  <Option text="Répéter un bloc d'instructions plusieurs fois." correct={false} />
  <Option text="Exécuter un bloc d'instructions uniquement si une certaine condition est vraie." correct={true} />
  <Option text="Définir une nouvelle variable." correct={false} />
  <Option text="Afficher un message à l'utilisateur." correct={false} />
</Question>
    <Question q="Dans l'expression logique (A ET B) OU C, si A est VRAI, B est FAUX et C est VRAI, quelle est la valeur de l'expression ?" explanation="(VRAI ET FAUX) donne FAUX. FAUX OU VRAI donne VRAI. L'opérateur ET est prioritaire sur OU.">
  <Option text="VRAI" correct={true} />
  <Option text="FAUX" correct={false} />
</Question>
    <Question q="Quelle est la différence fondamentale entre une boucle TANT QUE et une boucle POUR ?" explanation="La boucle POUR (for) est généralement utilisée lorsque le nombre d'itérations est connu ou peut être déterminé au début de la boucle. La boucle TANT QUE (while) est utilisée lorsque le nombre d'itérations est inconnu et dépend d'une condition qui peut changer pendant l'exécution.">
  <Option text="TANT QUE est utilisée pour un nombre d'itérations connu à l'avance, POUR pour un nombre inconnu." correct={false} />
  <Option text="TANT QUE est utilisée pour un nombre d'itérations inconnu à l'avance, POUR pour un nombre connu." correct={true} />
  <Option text="TANT QUE exécute toujours au moins une fois, POUR peut ne jamais s'exécuter." correct={false} />
  <Option text="Il n'y a pas de différence fondamentale, elles sont interchangeables." correct={false} />
</Question>
    <Question q="Considérez l'algorithme suivant :
VARIABLE i : ENTIER
DEBUT
    i <- 0
    TANT QUE i < 3 FAIRE
    ...
    FIN TANT QUE
FIN
Combien de fois le mot &quot;Bonjour&quot; sera-t-il affiché ?" explanation="La variable i prendra successivement les valeurs 0, 1, 2. Pour i=3, la condition i < 3 devient fausse et la boucle s'arrête. Donc, &quot;Bonjour&quot; est affiché 3 fois.">
  <Option text="0 fois" correct={false} />
  <Option text="1 fois" correct={false} />
  <Option text="3 fois" correct={true} />
  <Option text="Une infinité de fois" correct={false} />
</Question>
    <Question q="Quel est le résultat de l'algorithme suivant ?
VARIABLE x : ENTIER
DEBUT
    x <- 10
    SI x ">
5 ALORS
    ...
    FIN SI
    AFFICHER x
FIN » explanation=« x est initialisé à 10. La condition x > 5 (10 > 5) est vraie. Donc, x devient 10 + 2 = 12. L'algorithme affiche 12. »>
  <Option text="9" correct={false} />
  <Option text="10" correct={false} />
  <Option text="11" correct={false} />
  <Option text="12" correct={true} />
</Question>
    <Question q="Une boucle infinie se produit lorsque :" explanation="Une boucle infinie est une boucle dont la condition de continuation reste toujours vraie, ou dont la condition d'arrêt ne devient jamais fausse, empêchant ainsi le programme de progresser au-delà de cette boucle.">
  ...
  <Option text="La variable de contrôle de la boucle est initialisée à zéro." correct={false} />
</Question>
    <Question q="Quel est le rôle de l'opérateur d'affectation (<- ou =) en algorithmique ?" explanation="L'opérateur d'affectation permet de stocker une valeur (résultat d'une expression, constante, autre variable) dans une variable.">
  <Option text="Comparer deux valeurs." correct={false} />
  <Option text="Déclarer une nouvelle variable." correct={false} />
  <Option text="Attribuer une valeur à une variable." correct={true} />
  <Option text="Exécuter une fonction." correct={false} />
</Question>
    <Question q="Considérez l'algorithme :
...
DEBUT
    ...
    AFFICHER compteur
FIN
Quelle valeur sera affichée pour compteur ?" explanation="La boucle POUR i DE 1 A 5 s'exécute 5 fois (pour i=1, 2, 3, 4, 5). À chaque itération, compteur est incrémenté de 1. Donc, compteur passera de 0 à 5.">
  <Option text="0" correct={false} />
  <Option text="1" correct={false} />
  <Option text="5" correct={true} />
  <Option text="6" correct={false} />
</Question>
    <Question q="Si un algorithme contient une structure SI imbriquée dans une autre structure SI, comment les conditions sont-elles évaluées ?" explanation="Pour qu'un bloc d'instructions dans un SI imbriqué soit exécuté, la condition du SI externe doit d'abord être vraie, puis la condition du SI interne doit également être vraie.">
  <Option text="Seule la condition la plus interne est évaluée." correct={false} />
  <Option text="Les deux conditions doivent être vraies pour que le bloc d'instructions interne soit exécuté." correct={true} />
  <Option text="Les conditions sont évaluées en parallèle." correct={false} />
  <Option text="Seule la condition la plus externe est évaluée." correct={false} />
</Question>
</Quiz>
...
<References itemsBase64="" />
