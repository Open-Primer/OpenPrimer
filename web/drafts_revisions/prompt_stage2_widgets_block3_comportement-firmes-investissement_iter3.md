...
🚨 PREVIOUS CRITIQUE:
"The block contains critical media rule violations. Image and Video components must not contain a 'year' property in their 'props' object. This information is automatically resolved downstream.
Detailed errors:
- Field "interactiveComponents[1].props.year": The 'year' property is forbidden for Image components. This information is automatically resolved downstream.
- Field "interactiveComponents[3].props.year": The 'year' property is forbidden for Video components. This information is automatically resolved downstream."
