...
*   **Introduction (environ 10-15% de la longueur totale) :**
    ...
    *   **Définition des termes clés :** Précisez le sens des concepts géographiques et climatologiques majeurs du sujet. Par exemple, si le sujet porte sur les "mécanismes de la [[WIDGET:ConceptLink:circulation_atmospherique:circulation atmosphérique générale]]", il faudra définir ce concept et ses composantes essentielles.
...
*   **Références académiques :** Mentionner les auteurs ou les théories clés, comme les travaux de Jean Tricart sur la géomorphologie [ref3] ou les rapports du GIEC sur le changement climatique [ref6], pour montrer une connaissance des fondements disciplinaires.
