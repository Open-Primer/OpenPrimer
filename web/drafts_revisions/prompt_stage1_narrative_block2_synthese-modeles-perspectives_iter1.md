...
* Heading: "## Analyse Comparative : Forces et Faiblesses des Modèles"
  Instructions: "Comparer les différents modèles en termes de leur capacité à expliquer les cycles économiques, la croissance à long terme, l'inflation et le chômage. Discuter de leurs limites, de leurs hypothèses simplificatrices et de leur pertinence pour l'analyse des politiques économiques contemporaines."
* Heading: "## Évolutions et Perspectives Futures de la Macroéconomie"
  Instructions: "Aborder les pistes de recherche actuelles et futures en macroéconomie. Discuter des évolutions des modèles (ex: intégration des agents hétérogènes, macroéconomie comportementale, macroéconomie climatique, rôle des données massives) et des défis posés par les crises récentes et les nouvelles problématiques mondiales."
...
- Lesson Title: "Synthèse des modèles macroéconomiques et perspectives futures"
- Discipline: "Économie"
- Target Language: "FR"
...
"""
... mentales :** Rendements non décroissants du capital (via le capital humain, la R&D, les externalités positives), investissement dans la connaissance et l'innovation.
