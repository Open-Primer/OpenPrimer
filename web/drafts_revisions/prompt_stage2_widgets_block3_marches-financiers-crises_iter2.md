...
🚨 PREVIOUS CRITIQUE:
"The block contains an Image component with a forbidden 'year' property. Image components must not contain 'url', 'wikipediaUrl', 'wikipediaLink', 'imageUrl', or 'year' properties.
Detailed errors:
- Field "interactiveComponents": The Image component with id 'marches_financiers_overview' includes a 'year' property in its 'props', which is explicitly forbidden for Image components. Please remove the 'year' property."
