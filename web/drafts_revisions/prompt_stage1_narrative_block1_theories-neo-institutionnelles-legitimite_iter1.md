...
* Heading: "## Introduction aux Théories Néo-Institutionnelles et à la Légitimité"
  Instructions: "Cette section introduira le concept des théories néo-institutionnelles, leur émergence en sociologie des organisations, et leur pertinence pour comprendre les dynamiques organisationnelles contemporaines. Elle définira également la notion de légitimité organisationnelle et son importance."
* Heading: "## Les Piliers Institutionnels et l'Isomorphisme"
  Instructions: "Cette partie explorera les trois piliers institutionnels (régulatif, normatif, culturel-cognitif) qui façonnent les organisations. Elle détaillera ensuite les mécanismes de l'isomorphisme (coercitif, mimétique, normatif) et comment ils conduisent à l'homogénéisation des formes et des pratiques organisationnelles."
