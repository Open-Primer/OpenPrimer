...
* Heading: "## Introduction au cycle hydrologique et aux ressources en eau"
  Instructions: "Présenter l'importance de l'eau douce pour les écosystèmes et les sociétés humaines. Définir le cycle hydrologique comme un processus fondamental et introduire les enjeux liés à sa gestion."
* Heading: "## Les processus fondamentaux du cycle hydrologique"
  Instructions: "Détailler les différentes phases du cycle: évaporation (transpiration, évapotranspiration), condensation et précipitation, ruissellement (superficiel et hypodermique) et infiltration. Expliquer les facteurs influençant chaque processus."
...
- Lesson Title: "Le cycle hydrologique et les ressources en eau: dynamique et enjeux"
...
"The block's narrative quality, academic density, and MDX/JSX safety are excellent. However, the block fails to meet the pedagogical widget requirements. Specifically, it is missing several mandated widget types: 'HistoricalAnecdote', 'SolvedExercise', 'UnsolvedExercise', and 'DataChart'. The prompt explicitly states that if any mandated widget types are missing, the block must be rejected. Please incorporate these missing widget types to ensure a comprehensive pedagogical experience."
