...
- **Lesson Slug**: "fondations-espagnol-langue-latine"
- **Target Language**: "FR"
- **Course Discipline**: "Langue"
- **Epistemological Matrix**: "Sciences Appliquées / Ingénierie"
- **Expected Cognitive Artifact**: "Analyse textuelle et cartographie linguistique"
- **Expected Guidelines / Technical Depth**: "Présentation des origines et de l'importance de l'espagnol, contextualisation linguistique et culturelle, et aperçu des défis et facilités pour les francophones."
...
10. **Custom Pronunciation Sandbox (For Language & Linguistics courses)**:
    - If the course discipline is Language, Linguistics, or deals with phonetics/pronunciation, you MUST systematically integrate **2 to 3** `<SandboxPrononciation />` (if Target Language is FR) or `<PronunciationSandbox />` (if Target Language is EN/Other) components directly within your text in the phonetic or pronunciation section(s).
    - Format:
      `<SandboxPrononciation word="palabra" ipa="paˈlaβɾa" lang="es" definition="mot" explanation="Le 'b' entre deux voyelles est fricatif, beaucoup plus doux et continu qu'en français." />`
    - Props:
      - `word`: The exact foreign word or short phrase to practice.
      - `ipa` (optional): Phonetic representation using the International Phonetic Alphabet (IPA).
      - `lang`: The BCP 47 language code of the word (e.g., "es", "en", "de").
      - `definition` (optional): The translation or brief definition.
      - `explanation` (optional): An articulatory tip or pedagogical tip to help students pronounce the word.
