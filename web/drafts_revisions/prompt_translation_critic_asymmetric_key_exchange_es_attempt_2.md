...
__JSX_OPEN_Quiz_16__
  __JSX_ATTR_Question_17__ Si Eve intercepta la clave pública B de Bob y la clave pública A de Alice, ¿por qué no puede simplemente multiplicarlas para obtener el secreto compartido? ||| Multiplicar las claves públicas de Bob y Alice da (g^a) * (g^b) = g^(a+b) mod p. El secreto compartido es g^(ab) mod p. Multiplicar las claves públicas no produce la multiplicación de los exponentes, lo que demuestra por qué el protocolo es seguro. __JSX_END_17__
  __JSX_ATTR_Option_18__ Multiplicarlas produce g^(a+b) mod p, lo cual es matemáticamente diferente del secreto compartido g^(ab) mod p. __JSX_END_18__
  __JSX_ATTR_Option_19__ Porque multiplicar enteros modulares es extremadamente lento. __JSX_END_19__
  __JSX_ATTR_Option_20__ Porque A y B son números de coma flotante decimales. __JSX_END_20__
  __JSX_ATTR_Option_21__ Porque las claves públicas están cifradas con la clave secreta de la CA. __JSX_END_21__
__JSX_CLOSE_Question_5__
__JSX_CLOSE_Quiz_6__
