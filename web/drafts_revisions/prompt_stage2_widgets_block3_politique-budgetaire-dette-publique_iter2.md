...
- Anchor: [[WIDGET:Image:public_debt_evolution:Évolution de la dette publique en pourcentage du PIB dans les pays développés]] (Type: "Image", ID: "public_debt_evolution", Topic: "Évolution de la dette publique en pourcentage du PIB dans les pays développés")
- Anchor: [[WIDGET:Mermaid:public_finance_sources:Flux de financement des dépenses publiques]] (Type: "Mermaid", ID: "public_finance_sources", Topic: "Flux de financement des dépenses publiques")
- Anchor: [[WIDGET:CustomFigure:impot_investissement:Impact des impôts sur l'investissement et l'offre de travail]] (Type: "CustomFigure", ID: "impot_investissement", Topic: "Impact des impôts sur l'investissement et l'offre de travail")
- Anchor: [[WIDGET:Mermaid:dette_impact_flow:Chaîne d'effets de la dette publique sur l'économie]] (Type: "Mermaid", ID: "dette_impact_flow", Topic: "Chaîne d'effets de la dette publique sur l'économie")
- Anchor: [[WIDGET:CustomFigure:r_g_debt_dynamics:Dynamique du ratio dette/PIB en fonction de r et g]] (Type: "CustomFigure", ID: "r_g_debt_dynamics", Topic: "Dynamique du ratio dette/PIB en fonction de r et g")
- Anchor: [[WIDGET:Mermaid:soutenabilite_risques:Risques d'une dette publique non soutenable]] (Type: "Mermaid", ID: "soutenabilite_risques", Topic: "Risques d'une dette publique non soutenable")
- Anchor: [[WIDGET:CustomFigure:global_debt_trends:Évolution récente de la dette publique mondiale en pourcentage du PIB]] (Type: "CustomFigure", ID: "global_debt_trends", Topic: "Évolution récente de la dette publique mondiale en pourcentage du PIB")
- Anchor: [[WIDGET:Mermaid:fiscal_monetary_interaction:Interaction entre politique budgétaire et monétaire]] (Type: "Mermaid", ID: "fiscal_monetary_interaction", Topic: "Interaction entre politique budgétaire et monétaire")
...
🚨 PREVIOUS CRITIQUE:
"The block contains an Image component with a forbidden 'year' property. The 'year' property is automatically resolved downstream and should not be present in the raw widget block.
Detailed errors:
- Field "interactiveComponents": The first interactive component (id: 'public_debt_evolution'), which is an Image type, contains a forbidden 'year' property in its 'props'. According to Critical Media Rules, 'year' is not allowed for Image components and should be removed."
