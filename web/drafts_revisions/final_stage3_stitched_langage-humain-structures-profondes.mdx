---
title: « Le langage humain : une exploration de ses structures profondes »
subject: « Introduction à la sémantique et à la phonétique »
level: « L1 »
module: « Le langage humain : une exploration de ses structures profondes »
order: 1
---

<Prerequisites itemsBase64="W10=" />

<DiagnosticQuiz question="Selon Ferdinand de Saussure, quelle distinction fondamentale permet de circonscrire l'objet d'étude de la linguistique en tant que science ?" options="La distinction entre le signifiant et le signifié|||La distinction entre la synchronie et la diachronie|||La distinction entre la langue et la parole|||La distinction entre la phonétique et la phonologie" correctIndex="2" targetSectionId="2. Les Origines de la Linguistique comme Science : Des Réflexions Antiques aux Révolutions Modernes" sectionTitle="Les Origines de la Linguistique comme Science" />
...
<Objectives>
  <Knowledge>
    <ul className="list-disc pl-4 space-y-1">
      <li>analyser les propriétés fondamentales du langage humain (traits de conception de Hockett) et les comparer avec les systèmes de communication animale.</li>
      <li>Évaluer la pertinence de la dichotomie saussurienne entre langue et parole pour l'étude scientifique du langage.</li>
      <li>Distinguer et caractériser les grandes écoles de pensée en linguistique, du structuralisme au générativisme, et leurs contributions majeures.</li>
      <li>analyser les principes fondamentaux de la phonétique et de la sémantique, et évaluer leur rôle dans la compréhension des mécanismes du langage.</li>
      <li>Évaluer les théories contemporaines sur les liens entre le langage et la cognition, incluant l'hypothèse Sapir-Whorf et les bases neurales du langage.</li>
    </ul>
  </Knowledge>
  <Skills>
    <ul className="list-disc pl-4 space-y-1">
      <li>analyser des phénomènes linguistiques élémentaires en utilisant des concepts de phonétique et de sémantique.</li>
      <li>Évaluer différentes théories de l'acquisition du langage (innéisme vs. empirisme/interactionnisme).</li>
      <li>Créer des réflexions argumentées sur la nature et la fonction du langage humain.</li>
    </ul>
  </Skills>
  <Attitudes>
    <ul className="list-disc pl-4 space-y-1">
      <li>Développer une curiosité intellectuelle pour la diversité des langues et des cultures.</li>
      <li>Apprécier la complexité et la richesse du langage comme faculté humaine unique.</li>
      <li>Adopter une approche critique et scientifique face aux phénomènes linguistiques.</li>
    </ul>
  </Attitudes>
</Objectives>
...
> ![Ferdinand_de_Saussure](https://upload.wikimedia.org/wikipedia/commons/8/8f/Ferdinand_de_Saussure.jpg)
...
Des figures comme <RealPerson name="Franz_Bopp" lang="fr" bio="Linguiste allemand, considéré comme l'un des fondateurs de la linguistique comparée. Il a étudié les relations entre les langues indo-européennes, en particulier le sanskrit." unresolved={true}>Franz Bopp</RealPerson> (1791-1867), qui a publié une grammaire comparée du sanskrit, du zend, du grec, du latin, du lithuanien, du gothique et de l'allemand, et <RealPerson name="Jacob_Grimm" lang="fr" bio="Philologue, juriste et mythologue allemand, connu pour ses travaux sur la linguistique historique et la 'Loi de Grimm' concernant les changements phonétiques dans les langues germaniques." unresolved={true}>Jacob Grimm</RealPerson> (1785-1863), célèbre pour sa « Loi de Grimm » décrivant les changements phonétiques réguliers dans les langues germaniques, ont joué un rôle pionnier. Leurs travaux ont démontré que les changements linguistiques ne sont pas aléatoires mais suivent des lois régulières, conférant à la linguistique un statut scientifique rigoureux.

> ![Indo-European_languages_map](https://upload.wikimedia.org/wikipedia/commons/7/7d/Indo-European_languages_distribution.png)
...
> ![International_Phonetic_Alphabet_chart](https://upload.wikimedia.org/wikipedia/commons/3/3f/IPA_Chart_2005_in_Bengali.svg)
...
> ![Speech_organs_diagram](https://upload.wikimedia.org/wikipedia/commons/0/00/Speech_Organ_%E0%A6%AC%E0%A6%BE%E0%A6%97%E0%A6%BF%E0%A6%A8%E0%A7%8D%E0%A6%A6%E0%A7%8D%E0%A7%B0%E0%A6%BF%E0%A6%AF%E0%A6%BC.jpg)
...
> ![Semantic_network_example](https://upload.wikimedia.org/wikipedia/commons/6/67/Semantic_Net.svg)
...
> ![Cognitive_Linguistics_Illustration](https://upload.wikimedia.org/wikipedia/commons/f/ff/Jigsaw-PNL.svg)
...
> ![Broca_and_Wernicke_areas](https://upload.wikimedia.org/wikipedia/commons/0/03/BrocasAreaSmall.png)
...
### Glossaire
<References itemsBase64="" />

- **Arbitraire du signe** : Principe selon lequel il n'existe pas de lien naturel ou motivé entre le signifiant (forme sonore ou graphique) et le signifié (concept) d'un signe linguistique ; le lien est conventionnel.
- **Double articulation** : Propriété du langage humain permettant de construire un nombre infini d'unités significatives (mots) à partir d'un nombre limité d'unités non significatives (phonèmes), et un nombre infini de phrases à partir des mots.
- **Langue (Saussure)** : Le système abstrait, collectif et virtuel de signes et de règles qui existe indépendamment de ses utilisateurs individuels, constituant l'objet d'étude privilégié de la linguistique structurale.
- **Phonème** : La plus petite unité sonore distinctive d'une langue, capable de différencier le sens de deux mots (ex: /p/ et /b/ dans 'pain' et 'bain').
- **Sémantique** : Branche de la linguistique qui étudie le sens des mots, des phrases et des énoncés, ainsi que les relations de sens entre eux.
