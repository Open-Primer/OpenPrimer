...
* Heading: "## Conclusion"
  Instructions: "Récapituler les concepts clés abordés dans la leçon : le modèle d'optimisation intertemporelle, la signification et la dérivation de l'équation d'Euler, et la distinction entre les effets de richesse et de substitution. Souligner l'importance de ces outils pour l'analyse des politiques économiques et la compréhension des agrégats macroéconomiques comme l'épargne et l'investissement."
...
"""
... jours négatif pour la consommation présente. Une augmentation de $r$ conduit à une diminution de $C_t$ et une augmentation de $C_{t+1}$ (si l'utilité marginale de la consommation future est positive).
