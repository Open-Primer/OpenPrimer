...
🚨 PREVIOUS CRITIQUE:
"One or more interactive components have an incorrect componentType for the content they represent.
Detailed errors:
- Field "interactiveComponents": The interactive component with id 'black_scholes' has a componentType of 'RealPerson' but its name 'Black-Scholes-Merton' and associated Wikipedia URL refer to a financial model, not a person. This component should likely be a 'ConceptLink' or 'Glossary'."
