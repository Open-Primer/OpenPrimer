...
- **Lesson Slug**: "sens-mots-semantique-lexicale"
- **Target Language**: "FR"
- **Course Discipline**: "Général"
- **Epistemological Matrix**: "Sciences humaines et discursives"
- **Expected Cognitive Artifact**: "Analyse de champs lexicaux, relations sémantiques (synonymie, antonymie, hyponymie), tests de commutation"
- **Expected Guidelines / Technical Depth**: "Définition du sens lexical, polysémie, homonymie, et les différentes relations de sens entre les mots."
