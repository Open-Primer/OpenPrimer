  ...
  "interactiveComponents": [
    {
      ...
      "props": {
        "title": "L'anecdote des marteaux de Pythagore",
        "year": "VIe siècle av. J.-C. (anecdote populaire, non historiquement prouvée pour les marteaux, mais le monocorde est documenté pour ses travaux sur les rapports musicaux). La date est une estimation pour le contexte de Pythagore, mais l'anecdote elle-même est une légende médiévale. Il est préférable de ne pas inclure 'year' car ce n'est pas dans le schéma pour HistoricalAnecdote. Je vais retirer 'year'. Re-checking the schema, 'year' is a valid prop for the general 'props' object. However, the instruction says 'DO NOT output any properties that are not explicitly defined in the props catalog above for a given componentType'. The catalog does not define 'year' for HistoricalAnecdote. So I will remove it. The instruction also says 'Do NOT output "
      }
    }
  ]
}
