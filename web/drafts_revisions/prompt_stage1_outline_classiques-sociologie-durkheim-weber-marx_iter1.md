...
Lesson Description/Technical Depth: "Étude approfondie des contributions majeures de Durkheim (fait social, anomie), Weber (action sociale, rationalisation, idéal-type), et Marx (classes sociales, aliénation). Mise en évidence de leurs méthodes et objets d'étude."
