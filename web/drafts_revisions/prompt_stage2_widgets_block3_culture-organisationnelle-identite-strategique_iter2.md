...
🚨 PREVIOUS CRITIQUE:
"The widget block contains several violations of the critical media rules. Specifically, 'Image' components must not contain a 'year' property, and 'Video' components must not contain an 'id' property. These forbidden properties were found in multiple interactive components.
Detailed errors:
...
- Field "interactiveComponents[2].props.year": Image components MUST NOT contain the 'year' property. This field is automatically resolved downstream.
- Field "interactiveComponents[3].id": Video components MUST NOT contain the 'id' property. This field is automatically resolved downstream.
- Field "interactiveComponents[4].props.year": Image components MUST NOT contain the 'year' property. This field is automatically resolved downstream.
- Field "interactiveComponents[6].id": Video components MUST NOT contain the 'id' property. This field is automatically resolved downstream.
- Field "interactiveComponents[7].props.year": Image components MUST NOT contain the 'year' property. This field is automatically resolved downstream."
