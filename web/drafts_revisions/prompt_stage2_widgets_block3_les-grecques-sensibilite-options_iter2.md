...
🚨 PREVIOUS CRITIQUE:
"Image components must not contain the 'year' property. This property is forbidden and should be removed from all Image component props.
Detailed errors:
- Field "interactiveComponents": Several Image components within 'interactiveComponents' contain the forbidden 'year' property in their 'props'. Specifically, 'delta_call_graph', 'gamma_option_graph', 'vega_option_graph', and 'hedging_challenges' all include 'year: "2023"'. The 'year' property is not allowed for Image components and must be removed."
