...
🚨 PREVIOUS CRITIQUE:
"The interactive components are not sufficiently informative or detailed. Each component's 'props' object should include a 'description' or 'summary' field to provide content for the hover card, explaining the concept, person, or term. Currently, they only contain 'name', 'text', and 'title', which are redundant and do not offer any additional information.
Detailed errors:
- Field "interactiveComponents": Each interactive component (ConceptLink, RealPerson, Glossary) within this array lacks a 'description' or 'summary' field in its 'props'. These fields are crucial for making the components informative and detailed, as required for hover cards. The current 'name', 'text', and 'title' fields are insufficient for providing educational content."
