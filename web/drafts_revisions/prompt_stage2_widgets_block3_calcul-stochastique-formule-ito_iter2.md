...
🚨 PREVIOUS CRITIQUE:
"The block contains an Image component with forbidden properties. Image components must not include 'year' in their props.
Detailed errors:
- Field "interactiveComponents[0].props.year": The 'year' property is forbidden for Image components. Please remove it."
