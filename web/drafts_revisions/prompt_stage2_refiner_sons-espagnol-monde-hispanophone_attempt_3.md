...
"1. Perfect Semantic & Anchor Alignment: The narrative includes an anchor for a Mermaid widget (e.g., '[[WIDGET:Mermaid:phonetic_chart]]'), but there is no corresponding entry for 'phonetic_chart' in the 'interactiveComponents' array of the JSON. All anchors in the narrative must have a matching widget in the JSON.
2. Academic Bibliography & Citation Style: The narrative's inline citation '[2](#ref-2)' refers to 'LingQ' and 'Radio Nacional de España', which are general information sources, not academic works. However, the 'references' array in the JSON at index 1 (corresponding to '#ref-2') lists 'Chomsky, Noam. 1957. "Syntactic Structures". The Hague: Mouton & Co.', which is an academic work. This creates a mismatch between the narrative's citation and the JSON's reference entry. All entries in the 'references' array must be real, authoritative academic works, and their inline citations must map 1-to-1 correctly."
