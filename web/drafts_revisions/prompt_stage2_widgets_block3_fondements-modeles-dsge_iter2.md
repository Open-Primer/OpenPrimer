...
🚨 PREVIOUS CRITIQUE:
"The block contains Image components that include the forbidden 'year' property in their 'props'. According to Critical Media Rule 5, 'Image components MUST NOT contain ... 'year' properties'. This issue affects multiple Image components within the 'interactiveComponents' array.
Detailed errors:
- Field "interactiveComponents": The following Image components within this array contain the forbidden 'year' property in their 'props': 'crra_utility_function', 'budget_constraint_graph', and 'dsge_extensions_diagram'. Please remove the 'year' property from these Image components."
