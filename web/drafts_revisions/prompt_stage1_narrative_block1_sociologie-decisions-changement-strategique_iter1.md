...
* Heading: "## Introduction à la Sociologie des Décisions et du Changement Stratégique"
  Instructions: "Présenter le cours, définir la sociologie des décisions et du changement stratégique, son importance dans le management contemporain, et annoncer la structure de la leçon."
* Heading: "## Les Fondements Sociologiques de la Décision Stratégique"
  Instructions: "Expliquer comment les acteurs, les jeux de pouvoir, les cultures organisationnelles et les réseaux sociaux influencent la formulation des décisions stratégiques, en s'appuyant sur des théories sociologiques classiques et contemporaines (ex: Crozier et Friedberg, Mintzberg)."
