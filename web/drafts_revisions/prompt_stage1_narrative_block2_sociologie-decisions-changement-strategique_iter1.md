...
* Heading: "## Le Changement Stratégique sous l'Angle Sociologique"
  Instructions: "Analyser le processus de changement stratégique non pas comme un acte purement rationnel, mais comme un phénomène social complexe, impliquant des dynamiques de pouvoir, des résistances, des négociations et des adaptations culturelles. Aborder les modèles de changement et leurs limites sociologiques."
* Heading: "## Acteurs, Pouvoir et Résistance au Changement"
  Instructions: "Détailler le rôle des différents acteurs (dirigeants, managers intermédiaires, employés, syndicats) dans le processus de changement. Examiner les sources et les manifestations de la résistance au changement, ainsi que les stratégies sociologiques pour la comprendre et la gérer."
...
- Lesson Title: "Sociologie des Décisions et du Changement Stratégique"
