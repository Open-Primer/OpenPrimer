...
* Heading: "## Le Rôle de la Banque Centrale et ses Instruments"
  Instructions: "Décrire les fonctions principales d'une banque centrale moderne (émission monétaire, prêteur en dernier ressort, régulateur). Détailler les instruments de politique monétaire conventionnels (taux directeurs, opérations d'open market) et non conventionnels."
* Heading: "## Mécanismes de Transmission des Chocs Monétaires"
  Instructions: "Analyser les différents canaux par lesquels la politique monétaire affecte l'économie réelle : canal des taux d'intérêt, canal du crédit, canal du taux de change, canal des anticipations. Illustrer avec des exemples concrets."
...
"""
... :6]]. Elles sont cruciales pour expliquer pourquoi la politique monétaire peut avoir des effets réels à court terme, contrairement aux modèles classiques où la monnaie est neutre.
