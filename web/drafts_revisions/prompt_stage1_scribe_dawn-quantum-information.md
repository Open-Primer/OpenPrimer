...
- **Lesson Slug**: "dawn-quantum-information"
- **Target Language**: "EN"
- **Course Discipline**: "General"
- **Epistemological Matrix**: "Deductive / Formal Sciences"
- **Expected Cognitive Artifact**: "Conceptual Map, Historical Timeline"
- **Expected Guidelines / Technical Depth**: "High-level overview of quantum mechanics' historical development and its implications for computation, focusing on foundational concepts and key figures. Introduction to the 'why' of quantum computing."
