  ...
  "interactiveComponents": [
    {
      ...
      "componentType": "Image",
      "sectionAnchor": "## La Grèce antique : un contexte géographique et politique fragmenté",
      "props": {
        "description": "Carte topographique et politique de la Grèce antique, illustrant le relief montagneux, les nombreuses îles, les vallées isolées et les côtes découpées. Elle met en évidence la répartition des principales cités-États (Athènes, Sparte, Corinthe, Thèbes, etc.) et les voies maritimes qui reliaient ces entités fragmentées. Les frontières naturelles et les zones d'influence sont clairement délimitées, soulignant la nature insulaire et péninsulaire de la civilisation grecque.",
