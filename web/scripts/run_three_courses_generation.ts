...
process.env.LIMIT_LESSONS = '2'; // Generate 2 lessons per course to satisfy "plusieurs leçons" efficiently
...
async function main() {
  const coursesToGenerate = [
    {
      name: "Philosophie des Sciences et Épistémologie",
      level: "L1",
      subject: "Philosophy",
      slug: "Philosophie_des_Sciences_et_Epistemologie"
    },
    {
      name: "Introduction à la Sociologie Contemporaine",
      level: "L1",
      subject: "Sociology",
      slug: "Introduction_a_la_Sociologie_Contemporaine"
    },
    {
      name: "Biologie Cellulaire et Moléculaire",
      level: "L1",
      subject: "Biology",
      slug: "Biologie_Cellulaire_et_Moleculaire"
    }
  ];
  ...
  console.log("\n🎉 All course generations completed!");
}
