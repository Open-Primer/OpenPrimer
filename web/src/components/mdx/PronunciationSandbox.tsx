...
export const PronunciationSandbox = ({
  ...
  return (
    <div className="pronunciation-sandbox-reset my-8 p-6 md:p-8 bg-gradient-to-br from-white via-slate-50 to-slate-100/50 border border-slate-200/80 rounded-[32px] shadow-lg dark:from-slate-900 dark:via-slate-900/90 dark:to-slate-950 dark:border-slate-800 dark:shadow-2xl relative overflow-hidden select-none">
        ...
        <div className="lg:col-span-5 flex flex-col items-center justify-center">
          <AnimatePresence mode="wait">
            {hasTested && score !== null ? (
              ...
              <div className="w-full h-48 border border-dashed border-slate-200/80 dark:border-slate-850/70 rounded-3xl flex flex-col items-center justify-center text-slate-400 dark:text-slate-500 p-6 text-center select-none">
