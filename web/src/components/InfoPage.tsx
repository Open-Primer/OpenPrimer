  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white font-sans pt-32 px-8">
      ...
      <div className="max-w-4xl mx-auto">
        <h1 className="text-5xl md:text-6xl font-black mb-8 tracking-tighter bg-clip-text text-transparent bg-gradient-to-r from-blue-400 via-violet-400 to-emerald-400">{title}</h1>
