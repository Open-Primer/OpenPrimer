...
const PERSONAL_TUTOR_TRANSLATIONS = {
  ...
  ES: {
    title: "Motor del Tutor IA",
    desc: "Elige entre usar el tutor de IA integrado por defecto de la plataforma o tus propias claves API personales.",
    type_internal: "Tutor integrado (Gemini - Gratis)",
    type_personal: "Tutor personal (Tu propia clave API)",
    advantages: "Ventajas: Privacidad absoluta, acceso a modelos avanzados (GPT-4o, Claude 3.5 Sonnet) y sin límites de frecuencia.",
    disadvantages: "Desventajas: Pagas por tu propio uso de la API (consumo de tokens). Requiere generar una clave API de desarrollador.",
    provider: "Seleccionar proveedor",
    model: "Seleccionar modelo",
    api_key: "Clave API",
    api_key_placeholder: "Introduce tu clave API de desarrollador",
    test_connection: "Probar conexión",
    test_loading: "Probando conexión...",
    test_success: "¡Conexión exitosa!",
    test_error: "La conexión falló. Por favor, comprueba tu clave y tus créditos.",
    get_key: "Obtén tu clave API:",
    gemini_studio: "Google AI Studio (Gemini)",
    openai_platform: "Plataforma OpenAI",
    anthropic_console: "Consola de Anthropic (Claude)"
  },
  DE: {
    title: "KI-Tutor-Engine",
    desc: "Wählen Sie zwischen dem standardmäßigen integrierten KI-Tutor der Plattform oder Ihren eigenen persönlichen API-Schlüsseln.",
    type_internal: "Integrierter Tutor (Gemini - Kostenlos)",
    type_personal: "Persönlicher Tutor (Ihr eigener API-Schlüssel)",
    advantages: "Vorteile: Absolute Privatsphäre, Zugriff auf fortschrittliche Modelle (GPT-4o, Claude 3.5 Sonnet) und keine Ratenbegrenzungen.",
    disadvantages: "Nachteile: Sie zahlen für Ihre eigene API-Nutzung (Token-Verbrauch). Erfordert die Generierung eines Entwickler-API-Schlüssels.",
    provider: "Anbieter auswählen",
    model: "Modell auswählen",
    api_key: "API-Schlüssel",
    api_key_placeholder: "Geben Sie Ihren persönlichen API-Schlüssel ein",
    test_connection: "Verbindung testen",
    test_loading: "Verbindung wird getestet...",
    test_success: "Verbindung erfolgreich!",
    test_error: "Verbindung verlaufen. Bitte überprüfen Sie Ihren Schlüssel und Ihr Guthaben.",
    get_key: "Holen Sie sich Ihren API-Schlüssel:",
    gemini_studio: "Google AI Studio (Gemini)",
    openai_platform: "OpenAI-Plattform",
    anthropic_console: "Anthropic-Konsole (Claude)"
  },
  ZH: {
    title: "AI 导师引擎",
    desc: "选择使用平台默认的内置 AI 导师，或使用您自己的个人 API 密钥。",
    type_internal: "内置导师 (Gemini - 免费)",
    type_personal: "个人导师 (您自己的 API 密钥)",
    advantages: "优点：绝对隐私、可使用高级模型（GPT-4o、Claude 3.5 Sonnet）且无请求频率限制。",
    disadvantages: "缺点：您需要为自己的 API 使用付费（Token 消耗）。需要生成开发者 API 密钥。",
    provider: "选择提供商",
    model: "选择模型",
    api_key: "API 密钥",
    api_key_placeholder: "输入您的个人 API 密钥",
    test_connection: "测试连接",
    test_loading: "正在测试连接...",
    test_success: "连接成功！",
    test_error: "连接失败。请检查您的密钥和余额。",
    get_key: "获取您的 API 密钥：",
    gemini_studio: "Google AI Studio (Gemini)",
    openai_platform: "OpenAI 平台",
    anthropic_console: "Anthropic 控制台 (Claude)"
  },
  PT: {
    title: "Motor do Tutor IA",
    desc: "Escolha entre usar o tutor de IA integrado padrão da plataforma ou suas próprias chaves de API pessoais.",
    type_internal: "Tutor integrado (Gemini - Grátis)",
    type_personal: "Tutor pessoal (Sua própria chave de API)",
    advantages: "Vantagens: Privacidade absoluta, acesso a modelos avançados (GPT-4o, Claude 3.5 Sonnet) e sem limites de taxa.",
    disadvantages: "Desvantagens: Você paga pelo seu próprio uso da API (consumo de tokens). Requer a geração de uma chave de API de desenvolvedor.",
    provider: "Selecionar provedor",
    model: "Selecionar modelo",
    api_key: "Chave API",
    api_key_placeholder: "Insira sua chave de API pessoal",
    test_connection: "Testar conexão",
    test_loading: "Testando conexão...",
    test_success: "Conexão bem-sucedida!",
    test_error: "Falha na conexão. Por favor, verifique sua chave e créditos.",
    get_key: "Obtenha sua chave de API:",
    gemini_studio: "Google AI Studio (Gemini)",
    openai_platform: "Plataforma OpenAI",
    anthropic_console: "Console do Anthropic (Claude)"
  },
  AR: {
    title: "محرك المعلم المدعوم بالذكاء الاصطناعي",
    desc: "اختر بين استخدام معلم الذكاء الاصطناعي الافتراضي المدمج في النظام الأساسي أو مفاتيح واجهة برمجة التطبيقات (API) الشخصية الخاصة بك.",
    type_internal: "المعلم المدمج (Gemini - مجاني)",
    type_personal: "المعلم الشخصي (مفتاح API الخاص بك)",
    advantages: "المزايا: خصوصية مطلقة، والوصول إلى النماذج المتقدمة (GPT-4o، و Claude 3.5 Sonnet)، وبدون حدود لمعدل الاستخدام.",
    disadvantages: "العيوب: أنت تدفع مقابل استخدام واجهة برمجة التطبيقات الخاصة بك (استهلاك الرموز). يتطلب توليد مفتاح واجهة برمجة تطبيقات للمطورين.",
    provider: "اختر المزود",
    model: "اختر النموذج",
    api_key: "مفتاح API",
    api_key_placeholder: "أدخل مفتاح واجهة برمجة التطبيقات الشخصي الخاص بك",
    test_connection: "اختبار الاتصال",
    test_loading: "جاري اختبار الاتصال...",
    test_success: "تم الاتصال بنجاح!",
    test_error: "فشل الاتصال. يرجى التحقق من المفتاح والرصيد الخاص بك.",
    get_key: "احصل على مفتاح واجهة برمجة التطبيقات الخاص بك:",
    gemini_studio: "Google AI Studio (Gemini)",
    openai_platform: "منصة OpenAI",
    anthropic_console: "منصة Anthropic (Claude)"
  },
  HI: {
    title: "एआई ट्यूटर इंजन",
    desc: "प्लेटफ़ॉर्म के डिफ़ॉल्ट अंतर्निहित एआई ट्यूटर या अपनी व्यक्तिगत एपीआई कुंजी का उपयोग करने के बीच चयन करें।",
    type_internal: "अंतर्निहित ट्यूटर (Gemini - निःशुल्क)",
    type_personal: "व्यक्तिगत ट्यूटर (आपकी अपनी एपीआई कुंजी)",
    advantages: "लाभ: पूर्ण गोपनीयता, उन्नत मॉडल (GPT-4o, Claude 3.5 Sonnet) तक पहुंच, और कोई दर सीमा नहीं।",
    disadvantages: "हानियां: आप अपने स्वयं के एपीआई उपयोग (टोकन खपत) के लिए भुगतान करते हैं। इसके लिए डेवलपर एपीआई कुंजी जेनरेट करना आवश्यक है।",
    provider: "प्रदाता चुनें",
    model: "मॉडल चुनें",
    api_key: "एपीआई कुंजी",
    api_key_placeholder: "अपनी व्यक्तिगत एपीआई कुंजी दर्ज करें",
    test_connection: "कनेक्शन का परीक्षण करें",
    test_loading: "कनेक्शन का परीक्षण किया जा रहा है...",
    test_success: "कनेक्शन सफल रहा!",
    test_error: "कनेक्शन विफल रहा। कृपया अपनी कुंजी और क्रेडिट की जांच करें।",
    get_key: "अपनी एपीआई कुंजी प्राप्त करें:",
    gemini_studio: "Google AI Studio (Gemini)",
    openai_platform: "OpenAI प्लेटफ़ॉर्म",
    anthropic_console: "Anthropic कंसोल (Claude)"
  },
  UR: {
    title: "اے آئی ٹیوٹر انجن",
    desc: "پلیٹ فارم کے ڈیفالٹ بلٹ ان اے آئی ٹیوٹر یا اپنی ذاتی API کیز استعمال کرنے کے درمیان انتخاب کریں۔",
    type_internal: "بلٹ ان ٹیوٹر (Gemini - مفت)",
    type_personal: "ذاتی ٹیوٹر (آپ کی اپنی API کی)",
    advantages: "فوائد: مکمل رازداری، جدید ماڈلز (GPT-4o، Claude 3.5 Sonnet) تک رسائی، اور شرح کی کوئی حد نہیں۔",
    disadvantages: "نقصانات: آپ اپنے API کے استعمال (ٹوکن کے استعمال) کے لیے ادائیگی کرتے ہیں۔ اس کے لیے ڈویلپر API کی تیار کرنا ضروری ہے۔",
    provider: "فراہم کنندہ منتخب کریں",
    model: "ماڈل منتخب کریں",
    api_key: "API کی",
    api_key_placeholder: "اپنی ذاتی API کی درج کریں",
    test_connection: "کنکشن ٹیسٹ کریں",
    test_loading: "کنکشن ٹیسٹ کیا جا رہا ہے...",
    test_success: "کنکشن کامیاب رہا!",
    test_error: "کنکشن ناکام ہو گیا۔ براہ کرم اپنی کی (key) اور کریڈٹ چیک کریں۔",
    get_key: "اپنی API کی حاصل کریں:",
    gemini_studio: "Google AI Studio (Gemini)",
    openai_platform: "OpenAI پلیٹ فارم",
    anthropic_console: "Anthropic کنسول (Claude)"
  }
};
