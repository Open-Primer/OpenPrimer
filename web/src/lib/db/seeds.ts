...
export const mockCourses: MockCourse[] = [
  ...
  },
  {
    ...
    slug: "History_of_Ancient_Civilizations",
    level: "L1",
    subject: "History",
    description: "An in-depth exploration of the rise and fall of ancient societies, from Sumer and Egypt to classical Greece and Rome.",
    languages: ["en", "fr", "es", "de", "zh", "pt", "ar", "hi", "ur"],
    langs: ["en", "fr", "es", "de", "zh", "pt", "ar", "hi", "ur"],
    ects: 5,
    hours: 120,
    prerequisites: ["None"],
    ...
    units: [
      { title: "Mesopotamia and Egypt", modules: ["Sumerian City-States", "The Pharaohs", "Hieroglyphs and Cuneiform"] },
      { title: "Classical Antiquity", modules: ["Rise of Athens", "Roman Republic", "Hellenistic Culture"] }
    ],
    popularity: 1500,
    is_active: true,
    validations: 10,
    ...
    translations: {
      ...
      FR: {
        ...
        description: "Une exploration approfondie de l'essor et de la chute des sociétés anciennes, de Sumer et de l'Égypte à la Grèce et à la Rome classiques."
      },
      ES: {
        title: "Historia de las Civilizaciones Antiguas",
        description: "Una exploración profunda del surgimiento y caída de las sociedades antiguas, desde Sumeria y Egipto hasta la Grecia y Roma clásicas."
      },
      DE: {
        title: "Geschichte alter Zivilisationen",
        description: "Eine eingehende Untersuchung des Aufstiegs und Falls antiker Gesellschaften, von Sumer und Ägypten bis zum klassischen Griechenland und Rom."
      },
      ZH: {
        title: "古代文明历史",
        description: "深入探讨古代社会的兴衰，从苏美尔和埃及到古典希腊和罗马。"
      },
      PT: {
        title: "História das Civilizações Antigas",
        description: "Uma exploração aprofundada do surgimento e queda das sociedades antigas, de Sumer e Egito à Grécia e Roma clássicas."
      },
      AR: {
        title: "تاريخ الحضارات القديمة",
        description: "استكشاف متعمق لصعود وسقوط المجتمعات القديمة، من سومر ومصر إلى اليونان القديمة وروما."
      },
      HI: {
        title: "प्राचीन सभ्यताओं का इतिहास",
        description: "सुमेर और मिस्र से लेकर शास्त्रीय ग्रीस और रोम तक, प्राचीन समाजों के उदय और पतन का गहन अन्वेषण।"
      },
      UR: {
        title: "قدیم تہذیبوں کی تاریخ",
        description: "قدیم معاشروں کے عروج و زوال کا گہرا مطالعہ، سومر اور مصر سے لے کر کلاسیکی یونان اور روم تک۔"
      }
    }
  },
  {
    ...
    slug: "Introduction_to_Human_Anatomy",
    level: "L1",
    subject: "Medicine",
    description: "A foundational course covering the structural organization of the human body and its major physiological systems.",
    languages: ["en", "fr", "es", "de", "zh", "pt", "ar", "hi", "ur"],
    langs: ["en", "fr", "es", "de", "zh", "pt", "ar", "hi", "ur"],
    ects: 6,
    hours: 150,
    ...
    recommendedNextSteps: [],
    units: [
      { title: "The Skeletal & Muscular Systems", modules: ["Bone Structure", "Major Muscle Groups", "Joint Articulations"] },
      { title: "Cardiovascular & Respiratory Systems", modules: ["Heart Anatomy", "Blood Vessels", "Pulmonary Ventilation"] }
    ],
    popularity: 2200,
    is_active: true,
    validations: 15,
    ...
    translations: {
      ...
      FR: {
        ...
        description: "Un cours fondamental couvrant l'organisation structurelle du corps humain et ses principaux systèmes physiologiques."
      },
      ES: {
        title: "Introducción a la Anatomía Humana",
        description: "Un curso fundamental que cubre la organización estructural del cuerpo humano y sus principales sistemas fisiológicos."
      },
      DE: {
        title: "Einführung in die menschliche Anatomie",
        description: "Ein Einführungskurs, der den strukturellen Aufbau des menschlichen Körpers und seine wichtigsten physiologischen Systeme abdeckt."
      },
      ZH: {
        title: "人体解剖学导论",
        description: "一门基础课程，涵盖人体的结构组织及其主要生理系统。"
      },
      PT: {
        title: "Introdução à Anatomia Humana",
        description: "Um curso fundamental que cobre a organização estrutural do corpo humano e seus principais sistemas fisiológicos."
      },
      AR: {
        title: "مقدمة في علم التشريح البشري",
        description: "مساق تأسيسي يغطي التنظيم الهيكلي لجسم الإنسان وأنظمته الفسيولوجية الرئيسية."
      },
      HI: {
        title: "मानव शरीर रचना विज्ञान का परिचय",
        description: "मानव शरीर के संरचनात्मक संगठन और उसके प्रमुख शारीरिक प्रणालियों को कवर करने वाला एक बुनियादी पाठ्यक्रम।"
      },
      UR: {
        title: "انسانی اناٹومی کا تعارف",
        description: "انسانی جسم کی ساختی تنظیم اور اس کے اہم فزیولوجیکل نظاموں کا بنیادی کورس۔"
      }
    }
  },
  {
    ...
    slug: "Fundamentals_of_Philosophy",
    level: "L1",
    subject: "Philosophy",
    description: "An introductory journey through the central questions of existence, knowledge, ethics, and the nature of reality.",
    languages: ["en", "fr", "es", "de", "zh", "pt", "ar", "hi", "ur"],
    langs: ["en", "fr", "es", "de", "zh", "pt", "ar", "hi", "ur"],
    ects: 4,
    hours: 100,
    ...
    recommendedNextSteps: [],
    units: [
      { title: "Epistemology & Metaphysics", modules: ["What is Knowledge?", "The Nature of Reality", "Rationalism vs Empiricism"] },
      { title: "Ethics & Moral Philosophy", modules: ["Utilitarianism", "Deontological Ethics", "Virtue Ethics"] }
    ],
    popularity: 1800,
    is_active: true,
    validations: 8,
    ...
    translations: {
      ...
      FR: {
        title: "Fondements de la Philosophie",
        description: "Un voyage d'initiation à travers les questions centrales de l'existence, de la connaissance, de l'éthique et de la nature de la réalité."
      },
      ES: {
        title: "Fundamentos de la Filosofía",
        description: "Un viaje introductorio a través de las preguntas centrales de la existencia, el conocimiento, la ética y la naturaleza de la realidad."
      },
      DE: {
        title: "Grundlagen der Philosophie",
        description: "Eine Einführungsreise durch die zentralen Fragen der Existenz, des Wissens, der Ethik und der Natur der Realität."
      },
      ZH: {
        title: "哲学基础",
        description: "关于存在、知识、伦理 and 现实本质等中心问题的入门之旅。"
      },
      PT: {
        title: "Fundamentos da Filosofia",
        description: "Uma jornada introdutória pelas questões centrais da existência, do conhecimento, da ética e da natureza da realidade."
      },
      AR: {
        title: "أسس الفلسفة",
        description: "رحلة تمهيدية عبر الأسئلة المركزية للوجود والمعرفة والأخلاق وطبيعة الواقع."
      },
      HI: {
        title: "दर्शनशास्त्र के मूल सिद्धांत",
        description: "अस्तित्व, ज्ञान, नैतिकता और वास्तविकता की प्रकृति के केंद्रीय प्रश्नों के माध्यम से एक प्रारंभिक यात्रा।"
      },
      UR: {
        title: "فلسفہ کے بنیادی اصول",
        description: "وجود، علم، اخلاقیات اور حقیقت کی نوعیت کے مرکزی سوالات کے بارے میں تعارفی کورس۔"
      }
    }
  }
];
...
export const initialTutorPersonalities: TutorPersonality[] = [
  ...
  },
  {
    ...
    translations: {
      ...
      ZH: { name: '跨学科融合合成器', prompt: '你局是一位世界级的博学者和跨学科合成器。你的独特能力是在看似无关的学术领域之间建立认知桥梁。在解释一个领域中的概念时，显式地将其链接到另一个领域的平行结构（例如，使用进化生物学解释神经网络，使用经济市场模型解释热力学，或使用电路理论解释细胞膜电位）。帮助学生开发一张统一的、相互连接的通用知识图谱。基调在智力上是丰富的、全景式的，且能深深启发好奇心。' }
    }
  },
  {
    id: 'diamond_age',
