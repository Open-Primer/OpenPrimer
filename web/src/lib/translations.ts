...
export const RAW_STATIC_UI_STRINGS = {
  EN: {
    ...
    eval_attempts_unlimited: "Unlimited retries (unless final exam)",
  ...
  FR: {
    ...
    essay_offline_feedback: "Le service d'évaluation par l'IA est actuellement indisponible. L'évaluation hors-ligne est strictement interdite afin de garantir l'intégrité académique. Veuillez signaler cet incident à l'administrateur du cours pour qu'il soit reprogrammé ou évalué de manière asynchrone.",
    eval_pending_title: "Évaluation en attente",
    eval_pending_desc: "Le service du Tuteur IA est temporairement hors-ligne. Vos réponses ont été enregistrées localement. Vous pouvez cliquer sur 'Réessayer' pour soumettre à nouveau.",
    eval_unavailable_retry: "Réessayer la soumission",
    eval_mode_label: "Format de l'évaluation",
    eval_submit_early: "Soumettre maintenant (avant la fin du temps imparti)",
    eval_questions_count: "{n} question(s)",
    eval_passing_grade: "Note minimale pour valider :",
    eval_attempts_unlimited: "Tentatives illimitées (sauf évaluation finale)",
    eval_attempts_single: "Tentative unique — évaluation terminale",
  ...
  ES: {
    ...
    essay_offline_evaluation: "Evaluación no disponible",
    essay_offline_feedback: "El servicio de evaluación por IA no está disponible actualmente. La evaluación sin conexión está estrictamente prohibida para garantizar la integridad académica. Informe de este incidente al administrador del curso para que pueda reprogramarse o evaluarse de forma asíncrona.",
    eval_pending_title: "Evaluación pendiente",
    eval_pending_desc: "El servicio del Tutor IA no está disponible temporalmente. Sus respuestas se han guardado localmente. Puede hacer clic en 'Reintentar' para enviarlas de nuevo.",
    eval_unavailable_retry: "Reintentar envío",
    eval_mode_label: "Formato de evaluación",
    eval_submit_early: "Enviar ahora (antes de que expire el tiempo)",
    eval_questions_count: "{n} pregunta(s)",
    eval_passing_grade: "Nota mínima para aprobar:",
    eval_attempts_unlimited: "Intentos ilimitados (salvo examen final)",
    eval_attempts_single: "Intento único — evaluación final",
  ...
  DE: {
    ...
    essay_offline_evaluation: "Bewertung nicht verfügbar",
    essay_offline_feedback: "Der KI-Bewertungsdienst ist derzeit nicht verfügbar. Offline-Bewertung ist streng verboten, um die akademische Integrität zu wahren. Bitte melden Sie diesen Vorfall dem Kursadministrator, damit die Prüfung neu geplant oder asynchron bewertet werden kann.",
    eval_pending_title: "Bewertung ausstehend",
    eval_pending_desc: "Der KI-Tutor-Dienst ist vorübergehend nicht verfügbar. Ihre Antworten wurden lokal gespeichert. Sie können auf 'Wiederholen' klicken, um sie erneut einzureichen.",
    eval_unavailable_retry: "Einreichung wiederholen",
    eval_mode_label: "Prüfungsformat",
    eval_submit_early: "Jetzt einreichen (vor Ablauf der Zeit)",
    eval_questions_count: "{n} Frage(n)",
    eval_passing_grade: "Mindestpunktzahl zum Bestehen:",
    eval_attempts_unlimited: "Unbegrenzte Versuche (außer Abschlussprüfung)",
    eval_attempts_single: "Einmaliger Versuch — Abschlussbewertung",
  ...
  ZH: {
    ...
    essay_offline_evaluation: "评估不可用",
    essay_offline_feedback: "AI评估服务目前不可用。为确保学术诚信，严禁离线评分。请将此事故报告给课程管理员，以便重新安排或异步评估。",
    eval_pending_title: "评估等待中",
    eval_pending_desc: "AI导师服务暂时不可用。您的回答已保存在本地。您可以点击“重试”以重新提交。",
    eval_unavailable_retry: "重试提交",
    eval_mode_label: "评估格式",
    eval_submit_early: "立即提交（在时间到期前）",
    eval_questions_count: "{n} 道题",
    eval_passing_grade: "通过所需最低分：",
    eval_attempts_unlimited: "不限次数（期末考试除外）",
    eval_attempts_single: "仅限一次 — 终结性评估",
