...
const HEALTH_STRINGS = {
  ...
  PT: {
    ...
    cron_title: '⏰ Agendamentos de Cron Soberanos e Auditorias Contínuas',
    cron_desc: 'Desvios de agendamento dinâmico e auditorias contínuas do catálogo para equilibrar a carga de tarefas intensivas baseadas em agentes.',
    col_agent: 'Tarefa de Agente',
    col_schedule: 'Agendamento Cron',
    col_timing: 'Desvio de Tempo',
    col_load: 'Carga de Computação',
    agent_gen: 'Motor de Geração de Cursos',
    agent_trans: 'Motor de Tradução JIT',
    agent_rev: 'Motor de Revisão Pedagógica',
    offset_gen: 'Todos os dias às 02:00 AM UTC (Fora de pico)',
    offset_trans: 'Todos os dias às 04:00 AM UTC (Fora de pico)',
    offset_rev: 'Todos os dias às 06:00 AM UTC (Fora de pico)',
    load_low: 'Baixa (Sequencial)',
    load_med: 'Média (Equilibrada)',
    load_high: 'Alta (Distribuída)',
    audit_title: '🔄 Estado de Auditoria Contínua do Catálogo',
    audit_desc: 'Em vez de auditar todos os cursos diariamente, uma fração contínua de 1/15 é analisada a cada dia com base nos hashes dos seus IDs.',
    audit_stat: 'Lote Contínuo de Hoje: 1/15 (1 curso auditado de um total de 11)',
    pipeline_active: 'Balanceamento de Carga de Pipeline Ativo: Forçado (Máx. 2 tarefas concorrentes de alta intensidade)',
  ...
  AR: {
    ...
    error: 'تفاصيل الخطأ',
    cron_title: '⏰ توقيتات كرون السيادية والتدقيق المستمر',
    cron_desc: 'جدولة ديناميكية وتدقيق مستمر للفهرس لموازنة عبء المهام عالية الكثافة القائمة على الوكلاء.',
    col_agent: 'مهمة الوكيل',
    col_schedule: 'جدول كرون',
    col_timing: 'إزاحة التوقيت',
    col_load: 'عبء الحوسبة',
    agent_gen: 'محرك توليد الدورات',
    agent_trans: 'محرك الترجمة الفورية JIT',
    agent_rev: 'محرك المراجعة البيداغوجية',
    offset_gen: 'يومياً الساعة 02:00 صباحاً بالتوقيت العالمي (خارج أوقات الذروة)',
    offset_trans: 'يومياً الساعة 04:00 صباحاً بالتوقيت العالمي (خارج أوقات الذروة)',
    offset_rev: 'يومياً الساعة 06:00 صباحاً بالتوقيت العالمي (خارج أوقات الذروة)',
    load_low: 'منخفض (تسلسلي)',
    load_med: 'متوسط (متوازن)',
    load_high: 'مرتفع (موزع)',
    audit_title: '🔄 حالة التدقيق المستمر للفهرس',
    audit_desc: 'بدلاً من تدقيق جميع الدورات يومياً، يتم تحليل جزء مستمر يمثل 1/15 كل يوم بناءً على تجزئة المعرف الخاص بها.',
    audit_stat: 'دفعة اليوم المستمرة: 1/15 (تم تدقيق دورة واحدة من أصل 11 إجمالاً)',
    pipeline_active: 'موازنة عبء خط الأنابيب النشط: مطبق (الحد الأقصى مهمتان متزامنتان عاليتان الكثافة)',
  ...
  HI: {
    ...
    error: 'त्रुटि विवरण',
    cron_title: '⏰ संप्रभु क्रॉन समय और रोलिंग ऑडिट',
    cron_desc: 'उच्च-तीव्रता वाले एजेंटिक कार्यों को लोड-बैलेंस करने के लिए गतिशील शेड्यूलिंग ऑफ़सेट और रोलिंग कैटलॉग ऑडिट।',
    col_agent: 'एजेंटिक कार्य',
    ...
    offset_trans: 'प्रतिदिन 04:00 AM UTC पर (गैर-पीक समय)',
    offset_rev: 'प्रतिदिन 06:00 AM UTC पर (गैर-पीक समय)',
    load_low: 'कम (अनुक्रमिक)',
    load_med: 'मध्यम (संतुलित)',
    load_high: 'उच्च (वितरित)',
    audit_title: '🔄 रोलिंग कैटलॉग ऑडिट स्थिति',
    audit_desc: 'दैनिक रूप से सभी पाठ्यक्रमों का ऑडिट करने के बजाय, उनके आईडी हैश के आधार पर प्रत्येक दिन एक रोलिंग 1/15वां हिस्सा विश्लेषित किया जाता है।',
    audit_stat: 'आज का रोलिंग बैच: 1/15वां (कुल 11 में से 1 पाठ्यक्रम का ऑडिट किया गया)',
    pipeline_active: 'सक्रिय पाइपलाइन लोड बैलेंसिंग: लागू (अधिकतम 2 समवर्ती उच्च-तीव्रता वाले कार्य)',
  ...
  UR: {
    ...
    cron_title: '⏰ خود مختار کرون ٹائمنگز اور رولنگ آڈٹس',
    cron_desc: 'بوجھ کو متوازن کرنے کے لیے کرون ٹائمنگز۔',
    col_agent: 'ایجنٹک جاب',
    col_schedule: 'کرون شیڈول',
    col_timing: 'وقت کا آف سیٹ',
    col_load: 'کمپیوٹ بوجھ',
    agent_gen: 'کورس جنریشن انجن',
    agent_trans: 'JIT ٹرانسلیشن انجن',
    agent_rev: 'تدریسی نظرثانی انجن',
    offset_gen: 'روزانہ 02:00 AM UTC پر (آف پیک اوقات)',
    offset_trans: 'روزانہ 04:00 AM UTC पर (آف پیک اوقات)',
    offset_rev: 'روزانہ 06:00 AM UTC पर (آف پیک اوقات)',
    load_low: 'کم (تسلسلی)',
    load_med: 'متوسط (متوازن)',
    load_high: 'زیادہ (تقسیم شدہ)',
    audit_title: '🔄 رولنگ کیٹلاگ آڈٹ کی صورتحال',
    audit_desc: 'ID ہیشز کی بنیاد پر ہر روز رولنگ 1/15واں حصہ تجزیہ کیا جاتا ہے۔',
    audit_stat: 'آج کا رولنگ बैच: 1/15واں (کل 11 میں سے 1 کورس کا آڈٹ کیا گیا)',
    pipeline_active: 'فعال پائپ لائن لوڈ بیلنسنگ: نافذ',
