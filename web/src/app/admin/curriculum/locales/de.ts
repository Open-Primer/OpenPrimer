export const locale: Record<string, string> = {
  ...
  "Refresh Random Parameters": "Zufallsparameter aktualisieren",
  "Dynamic Sandbox Controls": "Dynamische Sandbox-Steuerelemente",
  "Name": "Name",
  ...
  "Beta": "Beta",
  "Gamma": "Gamma",
  "Production Stability Warning": "Warnung: Produktionsstabilität",
  "Modifying a widget's technical interface or parameters risks breaking all courses in production that render this widget. Always ensure strict backwards compatibility by keeping old props optional and supplying default fallback values in the component's code.": "Das Ändern der technischen Schnittstelle oder der Parameter eines Widgets birgt das Risiko, alle Kurse in der Produktion zu beschädigen, die dieses Widget rendern. Gewährleisten Sie immer eine strikte Abwärtskompatibilität, indem Sie neue Eigenschaften optional halten und robuste Standardwerte im Code der Komponente bereitstellen.",
  "Interactive Digital Logic Gate Laboratory": "Interaktives Digitales Logikgatter-Labor",
  "Interactive sandbox to build, toggle, and analyze logic circuits and truth tables.": "Interaktive Sandbox zum Erstellen, Umschalten und Analysieren von Logikschaltungen und Wahrheitstabellen.",
  "Genetics Pedigree Lab": "Genetik-Stammbaum-Labor",
  "Interactive Punnett Square and pedigree tree for simulating dominant, recessive, and sex-linked inheritance.": "Interaktives Punnett-Quadrat und Stammbaum zur Simulation von dominanter, rezessiver und geschlechtsgebundener Vererbung.",
  "2D Orbital Mechanics Simulator": "2D-Orbitalmechanik-Simulator",
  "2D Newtonian gravity sandbox: place stars, planets and satellites to observe Keplerian orbits and gravitational decay.": "Newtonsche 2D-Gravitations-Sandbox: Platzieren Sie Sterne, Planeten und Satelliten, um Kepler-Bahnen und Gravitationsabfall zu beobachten.",
  "Climate Impact Map": "Klimafolgenkarte",
  "Interactive map illustrating projected regional impacts of climate change on natural and human systems.": "Interaktive Karte zur Veranschaulichung der projizierten regionalen Auswirkungen des Klimawandels auf natürliche und menschliche Systeme.",
  "Interactive Periodic Table": "Interaktives Periodensystem",
  "Interactive chemical periodic table with a temperature slider, states of matter highlights, and animated 2D Bohr orbits.": "Interaktives chemisches Periodensystem mit Temperaturregler, Hervorhebung der Aggregatzustände und animierten 2D-Bohrschen Bahnen.",
  "Keplerian Solar System Orrery": "Keplersches Sonnensystem-Modell",
  "2D Keplerian orbit planetarium simulator on HTML5 canvas with orbital speeds, scale adjustments, and structural planet data.": "2D-Kepler-Planeten-Orrery-Simulator auf HTML5-Canvas mit Orbitalgeschwindigkeiten, Skalenanpassungen und physikalischen Planetendaten.",
  "OHLC Candlestick Financial Chart": "OHLC-Candlestick-Finanzdiagramm",
  "Japanese candlestick (OHLC) financial chart with a built-in price trends generator, SMA, and Bollinger Bands overlays.": "Japanisches Candlestick-Finanzdiagramm (OHLC) mit integriertem Preistrendgenerator, SMA- und Bollinger-Bänder-Overlays.",
  "Wave Double-Source Interference Tank": "Wellen-Doppelquellen-Interferenzbecken",
  "2D wave/ripple tank double-source interference simulator using high-performance canvas rendering and drag-to-adjust handles.": "2D-Wellen-/Rippelbecken-Doppelquellen-Interferenzsimulator mit leistungsstarkem Canvas-Rendering und Drag-to-Adjust-Griffen.",
  "ADSR Piano Synth & Oscilloscope": "ADSR-Pianosynthesizer und Oszilloskop",
