export const locale: Record<string, string> = {
  ...
  "Select subject fields...": "Select subject fields...",
  ...
  "Interactive Digital Logic Gate Laboratory": "Interactive Digital Logic Gate Laboratory",
  "Interactive sandbox to build, toggle, and analyze logic circuits and truth tables.": "Interactive sandbox to build, toggle, and analyze logic circuits and truth tables.",
  "Genetics Pedigree Lab": "Genetics Pedigree Lab",
  "Interactive Punnett Square and pedigree tree for simulating dominant, recessive, and sex-linked inheritance.": "Interactive Punnett Square and pedigree tree for simulating dominant, recessive, and sex-linked inheritance.",
  "2D Orbital Mechanics Simulator": "2D Orbital Mechanics Simulator",
  "2D Newtonian gravity sandbox: place stars, planets and satellites to observe Keplerian orbits and gravitational decay.": "2D Newtonian gravity sandbox: place stars, planets and satellites to observe Keplerian orbits and gravitational decay.",
  "Climate Impact Map": "Climate Impact Map",
  "Interactive map illustrating projected regional impacts of climate change on natural and human systems.": "Interactive map illustrating projected regional impacts of climate change on natural and human systems.",
  "Interactive Periodic Table": "Interactive Periodic Table",
  "Interactive chemical periodic table with a temperature slider, states of matter highlights, and animated 2D Bohr orbits.": "Interactive chemical periodic table with a temperature slider, states of matter highlights, and animated 2D Bohr orbits.",
  "Keplerian Solar System Orrery": "Keplerian Solar System Orrery",
  "2D Keplerian orbit planetarium simulator on HTML5 canvas with orbital speeds, scale adjustments, and structural planet data.": "2D Keplerian orbit planetarium simulator on HTML5 canvas with orbital speeds, scale adjustments, and structural planet data.",
  "OHLC Candlestick Financial Chart": "OHLC Candlestick Financial Chart",
  "Japanese candlestick (OHLC) financial chart with a built-in price trends generator, SMA, and Bollinger Bands overlays.": "Japanese candlestick (OHLC) financial chart with a built-in price trends generator, SMA, and Bollinger Bands overlays.",
  "Wave Double-Source Interference Tank": "Wave Double-Source Interference Tank",
  "2D wave/ripple tank double-source interference simulator using high-performance canvas rendering and drag-to-adjust handles.": "2D wave/ripple tank double-source interference simulator using high-performance canvas rendering and drag-to-adjust handles.",
  "ADSR Piano Synth & Oscilloscope": "ADSR Piano Synth & Oscilloscope",
