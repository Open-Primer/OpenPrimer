export const locale: Record<string, string> = {
  ...
  "Interactive Digital Logic Gate Laboratory": "Laboratorio interactivo de puertas lógicas",
  "Interactive sandbox to build, toggle, and analyze logic circuits and truth tables.": "Simulador interactivo para construir, alternar y analizar circuitos lógicos y tablas de verdad.",
  "Genetics Pedigree Lab": "Laboratorio de pedigrí genético",
  "Interactive Punnett Square and pedigree tree for simulating dominant, recessive, and sex-linked inheritance.": "Cuadrado de Punnett interactivo y árbol genealógico para simular herencia dominante, recesiva y ligada al sexo.",
  "2D Orbital Mechanics Simulator": "Simulador de mecánica orbital 2D",
  "2D Newtonian gravity sandbox: place stars, planets and satellites to observe Keplerian orbits and gravitational decay.": "Sandbox de gravedad newtoniana en 2D: coloca estrellas, planetas y satélites para observar órbitas keplerianas y decaimiento gravitatorio.",
  "Climate Impact Map": "Mapa de impacto climático",
  "Interactive map illustrating projected regional impacts of climate change on natural and human systems.": "Mapa interactivo que ilustra los impactos regionales proyectados del cambio climático en los sistemas naturales y humanos.",
  "Interactive Periodic Table": "Tabla periódica interactiva",
  "Interactive chemical periodic table with a temperature slider, states of matter highlights, and animated 2D Bohr orbits.": "Tabla periódica química interactiva con un deslizador de temperatura, resaltado de estados de la materia y órbitas animadas en 2D de Bohr.",
  "Keplerian Solar System Orrery": "Planetario del sistema solar kepleriano",
  "2D Keplerian orbit planetarium simulator on HTML5 canvas with orbital speeds, scale adjustments, and structural planet data.": "Simulador de planetario de órbita kepleriana en 2D en lienzo HTML5 con velocidades orbitales, ajustes de escala y datos estructurales de los planetas.",
  "OHLC Candlestick Financial Chart": "Gráfico financiero de velas OHLC",
  "Japanese candlestick (OHLC) financial chart with a built-in price trends generator, SMA, and Bollinger Bands overlays.": "Gráfico financiero de velas japonesas (OHLC) con generador de tendencias de precios incorporado, superposiciones de SMA y bandas de Bollinger.",
  "Wave Double-Source Interference Tank": "Tanque de interferencia de onda de doble fuente",
  "2D wave/ripple tank double-source interference simulator using high-performance canvas rendering and drag-to-adjust handles.": "Simulador de interferencia de doble fuente en tanque de ondas 2D utilizando renderizado de lienzo de alto rendimiento y controles de arrastre.",
  "ADSR Piano Synth & Oscilloscope": "Sintetizador de piano ADSR y osciloscopio",
  "Web Audio API-driven piano synth with ADSR envelopes, waveform selectors, and a real-time wave oscilloscope visualizer.": "Sintetizador de piano impulsado por la API Web Audio con envolventes ADSR, selectores de forma de onda y visualizador de osciloscopio en tiempo real.",
  "Sankey Flow Diagram": "Diagrama de flujo de Sankey",
  "Interactive vector SVG Sankey flow diagram with drag-to-adjust source/target handles.": "Diagrama de flujo de Sankey SVG vectorial interactivo con controles de arrastre para ajustar origen y destino.",
  "Disable Internal AI Tutor": "Desactivar Tutor IA Interno",
  "Disable the server-side internal AI tutor to prevent platform API usage costs. Students will be prompted to configure their own external AI tutor in Preferences.": "Desactivar el tutor IA interno del servidor para evitar costes de API. Se indicará a los estudiantes cómo configurar su propio tutor externo en Preferencias.",
  "Internal AI Tutor Engine Disabled": "Motor del Tutor IA Interno Desactivado",
  "The internal server AI tutor is currently disabled by administrator setting to optimize platform operating costs. To use AI tutoring, go to Profile > Preferences to configure your personal AI key (OpenAI, Anthropic, Gemini AI Studio).": "El tutor IA interno está actualmente desactivado por configuración de administración. Para utilizar la tutoría IA, vaya a Perfil > Preferencias y configure su clave de tutor externo (OpenAI, Anthropic, Gemini AI Studio).",
  "Global Course Cap Limit": "Límite Global de Cursos",
  "Maximum total number of courses allowed on the platform (e.g. 100,000). When exceeded, the system automatically prunes lowest-performing courses.": "Número máximo de cursos gestionados en la plataforma (ej. 100.000). Al superarlo, el sistema purga los cursos con menor calificación.",
  "Enforce Cap & Purge Lowest-Rated": "Aplicar Límite y Purgar los Menos Valorados",
  "Course cap enforced: {count} lowest-performing course(s) successfully purged.": "Límite aplicado: {count} curso(s) con menor calificación purgado(s) con éxito.",
  "Catalog is within the cap limit of {max} courses ({current} courses active).": "El catálogo está dentro del límite de {max} cursos ({current} cursos activos).",
  "EU AI Act Compliant • Art. 50 Disclosure": "Conforme Ley de IA UE • Divulgación Art. 50"
};
