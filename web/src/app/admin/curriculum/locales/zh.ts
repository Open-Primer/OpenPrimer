export const locale: Record<string, string> = {
  ...
  "Water Molecule (H₂O)": "水分子 (H₂O)",
  "Salt Crystal Lattice (NaCl)": "食盐晶体点阵 (NaCl)",
  "Graphene Layer": "石墨烯层",
  "1s Spherical": "1s 球形",
  "2s Spherical w/ Node": "含节点的 2s 球形",
  "2p_z Bilobed": "2p_z 双叶形",
  "3d_xy Quadrupolar": "3d_xy 四极形",
  "Add a premium preset for Ethanol (C2H5OH) molecule": "为乙醇 (C2H5OH) 分子添加高级预设",
  "Integrate a toggle to show/hide atomic labels in the viewport": "集成在视口中显示/隐藏原子标签的开关",
  "Apply a slow auto-rotation animation by default when rendering": "渲染时默认应用缓慢的自动旋转动画",
  "Add an hybrid sp3 tetrahedral orbital preset": "添加 sp3 杂化四面体轨道预设",
  "Integrate a toggle to animate the orbital lobes with a breeding effect": "集成一个开关，以呼吸效果使轨道叶动起来",
  "Add a scale slider to adjust probe size visually": "添加缩放滑块以视觉调整探针大小",
  "Add an input field to let students configure gravity explicitly": "添加输入框让学生显式配置重力",
  "Draw the trajectory curve trail with a glowing neon line": "用发光的霓虹线绘制轨迹曲线轨迹",
  "Add a preset option for an elastic collision test case": "为弹性碰撞测试用例添加预设选项",
  "Inject responsive screen adjustments to the container": "向容器注入响应式屏幕调整",
  "Add a help tool-tip describing the fundamental equations": "添加描述基本方程的帮助工具提示",
  "Make the sliders look modern and premium using Tailwind CSS grid spacing": "使用 Tailwind CSS 网格间距使滑块看起来现代而高级",
  "Chemistry": "化学",
  "Physics": "物理",
  "Mathematics": "数学",
  "Biology": "生物",
  ...
  "Monitor, inspect, preview, and safely compile prompt-driven enhancements to interactive curriculum blocks.": "监控、检查、预览并安全编译基于提示词的交互式课程块增强功能。",
  "Refresh": "刷新",
  "Create Widget": "创建组件",
  "Filter components, subjects...": "筛选组件、学科...",
  "Scanning MDX directory...": "正在扫描 MDX 目录...",
  "No matching widgets": "没有匹配的组件",
  "Interactive Live Sandbox": "交互式实时沙盒",
  "TSX Source Code": "TSX 源代码",
  "Props & API Schema": "Props 与 API 架构",
  "Fullscreen Preview": "全屏预览",
  "AI Prompt Refinement Console": "AI 提示词微调控制台",
  "Compiling Sovereign Refinements...": "正在编译微调方案...",
  "AI Synthesis": "AI 合成",
  "Backup FS": "备份文件系统",
  "TSX Inject": "TSX 注入",
  "TSC Compile": "TSC 编译",
  "No Widget Selected": "未选择任何组件",
  "Component Locked Read-Only": "组件已锁定为只读",
  "Force Unlock": "强制解锁",
  "You hold the exclusive edit lock on this component": "您拥有该组件的独占编辑锁",
  "TSX Compilation Log Rejected": "TSX 编译日志已拒绝",
  "Feynman Console": "费曼控制台",
  "AI Prompt": "AI 提示词",
  ...
  "Interactive Digital Logic Gate Laboratory": "互动数字逻辑门实验室",
  "Interactive sandbox to build, toggle, and analyze logic circuits and truth tables.": "用于构建、切换和分析逻辑电路及真值表的互动沙盒。",
  "Genetics Pedigree Lab": "遗传谱系实验室",
  "Interactive Punnett Square and pedigree tree for simulating dominant, recessive, and sex-linked inheritance.": "用于模拟显性、隐性和伴性遗传的互动普氏方格和谱系树。",
  "2D Orbital Mechanics Simulator": "2D 轨道力学模拟器",
  "2D Newtonian gravity sandbox: place stars, planets and satellites to observe Keplerian orbits and gravitational decay.": "2D 牛顿重力沙盒：放置恒星、行星和卫星以观察开普勒轨道和引力衰减。",
  "Climate Impact Map": "气候影响地图",
  "Interactive map illustrating projected regional impacts of climate change on natural and human systems.": "展示气候变化对自然和人类系统预计区域影响的互动地图。",
  "Interactive Periodic Table": "互动元素周期表",
  "Interactive chemical periodic table with a temperature slider, states of matter highlights, and animated 2D Bohr orbits.": "具有温度滑块、物质状态高亮和动态 2D 玻尔轨道的互动化学元素周期表。",
  "Keplerian Solar System Orrery": "开普勒太阳系模型",
  "2D Keplerian orbit planetarium simulator on HTML5 canvas with orbital speeds, scale adjustments, and structural planet data.": "基于 HTML5 Canvas 的 2D 开普勒轨道行星仪模拟器，具有轨道速度、比例调整和行星结构数据。",
  "OHLC Candlestick Financial Chart": "OHLC K线金融图表",
  "Japanese candlestick (OHLC) financial chart with a built-in price trends generator, SMA, and Bollinger Bands overlays.": "具有内置价格趋势生成器、SMA和布林带叠加的日本蜡烛图（OHLC）金融图表。",
  "Wave Double-Source Interference Tank": "双源波干涉水槽",
  "2D wave/ripple tank double-source interference simulator using high-performance canvas rendering and drag-to-adjust handles.": "采用高性能 Canvas 渲染和拖拽调节手柄的 2D 波/波纹槽双源干涉模拟器。",
  "ADSR Piano Synth & Oscilloscope": "ADSR 钢琴合成器与示波器",
