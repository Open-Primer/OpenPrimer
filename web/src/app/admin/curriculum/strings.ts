...
export const CURRICULUM_STRINGS = {
  EN: {
    ...
    tab_widgets: "Interactive Widgets",
    tab_achievements: "Achievements Grid",
    tab_personalities: "AI Tutor Personalities",
    widgets_title: "Interactive Widget Workshop",
    widgets_subtitle: "Inspect, preview, and safely refine advanced interactive learning blocks with AI",
  ...
  FR: {
    ...
    tab_widgets: "Widgets Interactifs",
    tab_achievements: "Grille de Badges",
    tab_personalities: "Personnalités",
    widgets_title: "Atelier des Widgets Interactifs",
    widgets_subtitle: "Analyser, prévisualiser, affiner et générer des composants pédagogiques spécialisés",
  ...
  ES: {
    ...
    tab_widgets: "Widgets Interactivos",
    tab_achievements: "Badges y Medallas",
    tab_personalities: "Personalidades Tutor",
    widgets_title: "Taller de Widgets Interactivos",
    widgets_subtitle: "Inspeccionar, previsualizar y refinar de forma segura bloques de aprendizaje interactivos avanzados con IA",
  ...
  DE: {
    ...
    tab_widgets: "Interaktive Widgets",
    tab_achievements: "Errungenschaften",
    tab_personalities: "Tutor-Persönlichkeiten",
    widgets_title: "Workshop für interaktive Widgets",
    widgets_subtitle: "Erweiterte interaktive Lernblöcke mit KI analysieren, vorschauen und sicher optimieren",
  ...
  ZH: {
    ...
    widgets_title: "互动小部件创意工坊",
    widgets_subtitle: "使用人工智能检查、预览并安全地优化高级互动学习组件",
    auto_approve: "自动批准生成",
  ...
  PT: {
    ...
    tab_widgets: "Widgets Interativos",
    tab_achievements: "Grade de Conquistas",
    tab_personalities: "Personalidades do Tutor IA",
    widgets_title: "Oficina de Widgets Interativos",
    widgets_subtitle: "Inspecione, visualize e refine com segurança blocos de aprendizagem interativos avançados com IA",
  ...
  AR: {
    ...
    tab_widgets: "أدوات تفاعلية",
    tab_achievements: "شبكة الإنجازات",
    tab_personalities: "شخصيات معلم الذكاء الاصطناعي",
    widgets_title: "ورشة عمل الأدوات التفاعلية",
    widgets_subtitle: "فحص ومعاينة وتحسين كتل التعلم التفاعلية المتقدمة بأمان باستخدام الذكاء الاصطناعي",
  ...
  HI: {
    ...
    tab_widgets: "इंटरैक्टिव विजेट",
    tab_achievements: "उपलब्धि ग्रिड",
    tab_personalities: "एआई शिक्षक व्यक्तित्व",
    widgets_title: "इंटरैक्टिव विजेट कार्यशाला",
    widgets_subtitle: "एआई के साथ उन्नत इंटरैक्टिव शिक्षण ब्लॉकों का सुरक्षित रूप से निरीक्षण, पूर्वावलोकन और परिष्कृत करें",
  ...
  UR: {
    ...
    tab_widgets: "انٹرایکٹو وجیٹس",
    tab_achievements: "کامیابیوں کا گریڈ",
    tab_personalities: "اے آئی ٹیوٹر شخصیات",
    widgets_title: "انٹرایکٹو وجیٹ ورکشاپ",
    widgets_subtitle: "مصنوعی ذہانت (AI) کی مدد سے جدید تعلیمی وجیٹس کا معائنہ، پیش نظارہ اور محفوظ طریقے से بہتر بنائیں",
