...
export const COCKPIT_DICTIONARY = {
  ...
  FR: {
    ...
    "Manually initiate the creation of a new course or curriculum. The AI pipeline will assemble the semantic structure and pedagogical modules.": "Initiez manuellement la création d'un nouveau cours ou curriculum. Le pipeline d'IA assemblera la structure sémantique et les modules.",
    ...
    "Add custom discipline...": "Ajouter une discipline personnalisée...",
    "Custom Discipline Name": "Nom de la Discipline",
    ...
    "No refused proposals in backlog. High alignment.": "Aucune proposition refusée dans le backlog. Parfaite cohérence.",
    "Reason:": "Raison :",
    "Score:": "Score :",
    "Action:": "Action :",
    ...
    // 5. Pipeline Queue Tab
    "Active Task Pipeline Queue": "File d'Attente Active du Pipeline",
  ...
  ES: {
    ...
    "Manually initiate the creation of a new course or curriculum. The AI pipeline will assemble the semantic structure and pedagogical modules.": "Iniciar manualmente un curso o plan. El pipeline de IA armará la estructura y módulos.",
    ...
    "Subject / Discipline": "Asunto / Disciplina",
    "Add custom discipline...": "Añadir disciplina personalizada...",
    "Custom Discipline Name": "Nombre de Disciplina",
    ...
    "No refused proposals in backlog. High alignment.": "No hay propuestas rechazadas. Perfecta alineación.",
    "Reason:": "Razón:",
    "Score:": "Puntuación:",
    "Action:": "Acción:",
    ...
    // 5. Pipeline Queue Tab
    "Active Task Pipeline Queue": "Cola del Pipeline de Tareas Activas",
  ...
  DE: {
    ...
    "Manually initiate the creation of a new course or curriculum. The AI pipeline will assemble the semantic structure and pedagogical modules.": "Kurs oder Lehrplan manuell erstellen. Die KI-Pipeline baut Struktur und Module.",
    ...
    "Subject / Discipline": "Fachgebiet / Disziplin",
    "Add custom discipline...": "Benutzerdefiniertes Fach hinzufügen...",
    "Custom Discipline Name": "Fachgebiet Name",
    ...
    "No refused proposals in backlog. High alignment.": "Keine abgelehnten Vorschläge im Backlog. Hohe Ausrichtung.",
    "Reason:": "Grund:",
    "Score:": "Score:",
    "Action:": "Aktion:",
    ...
    // 5. Pipeline Queue Tab
    "Active Task Pipeline Queue": "Aktive Aufgabenwarteschlange",
  ...
  ZH: {
    ...
    "Manages the lifecycle of new course proposals and log archiving. Proposals are automatically generated by the engine under three dynamic pedagogical conditions:": "管理新课程提案与归档。引擎根据三种动态教学条件自动生成提案：",
    ...
    "Condition 2: Sovereign Academic Expansion": "条件 2：自主学术扩张推进",
    "Triggers progression suggestions based on student validation success. When a prerequisite course passes the Validations Threshold, the next-level progression course is proposed.": "基于学生通过率推荐课程。当先修课程通过次数达到阈值，将提议生成下一阶段的后续课程。",
    "Condition 3: Complete Core Curriculum Synthesis": "条件 3：完整核心课程体系合成",
    "Triggers when all constituent courses of an ungenerated curriculum exist. Automatically unifies isolated course blocks into a cohesive, structured learning pathway.": "当未生成课程体系的所有子课程均存在时触发。自动将独立的课程块合并为一个连贯的学习路径。",
    "Engine Control Variables": "引擎控制变量",
    "Auto-Approve Generation": "自动批准生成",
    "Enable to let the autonomy loop automatically promote qualified proposals directly to the generation queue.": "启用后将允许自主循环将符合条件的提案自动推送到生成队列中。",
    "Auto-Approve Delay": "自动批准冷却时间",
    "The cooldown period a proposal must remain visible to human review before the dynamic engine auto-promotes it.": "提案在自动晋升前供人工审核的展示等待时间。",
    "Hours": "小时",
    "Failure Threshold": "失败搜索阈值",
    "The minimum number of failed student search occurrences required for a query to be proposed.": "触发提案所需的最小未匹配搜索次数。",
    "Searches": "搜索次数",
    "Validations Threshold": "验证通过阈值",
    "The number of times a prerequisite course must be completed successfully before a next-level progression course is proposed.": "先修课程在提议后续课程前所需成功通过的次数。",
    "Completions": "通过次数",
    "Re-evaluation Interval": "重新评估周期",
    "The periodic interval (in hours) at which the autonomy engine re-assesses student metrics to discover new academic suggestions.": "引擎重新评估学生指标以发现新学术建议的周期（小时）。",
    "Backlog Retention": "已拒绝提案留存",
    "The duration (in days) a refused proposal remains in the backlog database before being permanently purged.": "被拒绝的提案在被永久清除前在数据库中保留的天数。",
    "Days": "天数",
    "Manual Academic Proposal": "手动学术课程提案",
    "Manually initiate the creation of a new course or curriculum. The AI pipeline will assemble the semantic structure and pedagogical modules.": "手动发起新课程或课程体系的构建。AI 管道将自动组装语义结构和教学模块。",
    "Course / Curriculum Title": "课程 / 课程体系名称",
    "e.g., Intro to General Relativity": "例如：广义相对论导论",
    "Content Type": "内容类型",
    "Standalone Course": "独立课程",
    "Full Curriculum": "完整课程体系",
    "Academic Level": "学术级别",
    "Subject / Discipline": "学科分类",
    ...
    "No refused proposals in backlog. High alignment.": "积压库中无已拒绝的提案。完美契合。",
    "Reason:": "原因:",
    "Score:": "评分:",
    "Action:": "操作:",
    "Approved by Autonomy": "自主循环已批准",
    "Re-evaluate & Force Release": "重新评估并强制发布",

    // 2. Translation Engine Tab
    "Dynamic Translation & Retention Engine": "多语言翻译与留存引擎",
    "Manages dynamic course localization requests. Proposals are autonomously computed by the engine based on two pedagogical triggers:": "管理课程的动态多语言翻译。引擎基于以下两个教学触发器自动计算提案：",
    "Condition 1: Unresolved Foreign Search Spikes": "条件 1：未解决的外语搜索激增",
    "Triggers a translation proposal when a user types an exact query for a course that exists in another language, but is missing in the typed language. Requires at least {searches} searches.": "当用户用本地语言搜索其他语言中存在但本地缺失的课程时，将触发翻译提案。",
    "Condition 2: High-Volume ECTS Completions": "Condition 2: 高额 ECTS 验证通过量",
    "Suggests translating popular courses into other registered languages when historical validations reach {completions} completions.": "当某课程的通过记录达到阈值时，建议将其翻译到其他已注册的语言中。",
    "Auto-Approve Translation": "自动批准翻译",
    "Allows qualified translation proposals to bypass manual validation and self-schedule to the pipeline queue.": "允许符合条件的翻译提案跳过人工验证并自动排入管道队列。",
    "Cooldown period of at least 24 hours required before a translation proposal is automatically approved and built.": "翻译提案被自动批准和构建前所需的至少24小时冷却时间。",
    "Failed Search Threshold": "失败搜索阈值",
    "Number of failed localizations typed by students in search queries to trigger translation recommendations.": "学生触发翻译推荐所需的未匹配搜索次数。",
    "Popularity Threshold": "热门度阈值",
    "Number of completions a course must gather in one language to trigger automatic localization recommendations for other languages.": "某课程在一门语言中触发自动外语本地化推荐所需的通过次数。",
    "Active Translation Proposals": "活跃翻译提案",
    "No pending localization suggestions in queue.": "队列中暂无待处理的多语言翻译建议。",
    "Source Lang:": "源语言:",
    "Target Lang:": "目标语言:",
    "Demand Count:": "搜索热度:",
    "Refused Translations Backlog": "已拒绝的翻译积压",
    "No refused translations in backlog. Good coverage.": "积压库中暂无已拒绝的翻译。覆盖良好。",

    // 3. Revision Engine Tab
    "Pedagogical Revision Engine Overview": "教学修订引擎概览",
    "The Revision Engine dynamically groups feedback reports and triggers proposed fixes at the course-chapter level. Two primary conditions are monitored in real-time by a dedicated AI Agent:": "修订引擎动态归纳反馈报告，并在章节级别触发拟议的修复方案。AI 智能体实时监测以下两个条件：",
    "Trigger 1: Low Global Rating": "触发器 1：低综合评分",
    "Triggers a general course revision if the average student rating drops below the Rating Threshold (≤ Stars) and has gathered a significant sample size (≥ Min Votes).": "若课程的平均学生评分降至阈值以下（且累积了足够的评价数），则触发整门课程的全面修订。",
    "Trigger 2: Concordant Error Reports": "触发器 2：一致性错误反馈报告",
    "Triggers a target-chapter revision when multiple users (≥ Min Reports) submit matching complaints. The AI Agent synthesizes these concordant reports into a single, structured fix.": "当多名学生提交针对同一章节的相同投诉时，触发指定章节的专项修订。AI 智能体将合成这些一致性报告。",
    "Auto-Approve Revisions": "自动批准修订",
    "Enable to let the pedagogical agent automatically apply qualified fixes directly to target chapters.": "启用后将允许教学智能体将符合条件的修复方案自动应用到对应章节。",
    "Proposes revision if overall rating falls at or below this stars count.": "在综合评分低于或等于此星级数时提议修订。",
    "Minimum Votes": "最小评价数",
    "Minimum rating submissions required to validate overall rating drop before suggesting revision.": "在建议修订前验证综合评分下降所需的最小评价份数。",
    "Votes": "评价数",
    "Report Threshold": "错误报告阈值",
    "Minimum matching error reports needed to trigger specific chapter revision proposals.": "触发特定章节修订提案所需的最小相同投诉报告数。",
    "Reports": "份报告",
    "Review Cooldown": "修订冷却期",
    "The period (in days) a course must stay in production after a revision before being eligible for a new revision proposal.": "课程在修订后必须在生产环境中持续运行的最少天数（在此期间不接受新修订提案）。",
    "Active Proposed Revisions": "活跃拟议修订案",
    "Chapter:": "章节:",
    "Issue:": "问题说明:",
    "Confidence:": "置信度:",
    "No pending pedagogical revision proposals. Core curriculum stable.": "暂无待处理的教学修订提案。核心课程状态稳定。",
    "Refused Revisions Backlog": "已拒绝修订积压",
    "No refused revisions in backlog.": "积压库中暂无已拒绝的修订。",

    // 4. Course Archiving Tab
    "Curriculum Registry and Archival Control": "课程体系注册与归档控制中心",
    "Search courses and archive/unarchive specific languages or entire courses instantly.": "即时搜索并归档/激活指定语言或整门课程。",
    "Search courses...": "搜索课程...",
    "Status": "状态",

    // 5. Pipeline Queue Tab
    "Active Task Pipeline Queue": "活跃构建任务管道队列",
    "Search tasks...": "搜索任务...",
    "No active tasks in queue. Build system idle.": "管道中暂无活跃任务。构建系统空闲。",

    // 6. Achievements Tab
    "Strict Parameter Check": "严格参数校验模式",
    "When enabled, badges parameters are strictly validated (no emojis in name, threshold must be > 0).": "开启后，勋章参数将接受严格校验（名称禁止表情，阈值必须大于0）。",
    "Achievement Badge Registry": "成就勋章注册管理中心",
    "Manage gamified rewards and ECTS triggers. Add new badges or modify active ones.": "管理趣味化学术奖励与 ECTS 触发条件。可创建新勋章或修改现有勋章。",
    "Register Badge": "注册勋章",
    "Icon": "勋章图标",
    "Badge Name": "勋章名称",
    "Description": "勋章描述",
    "Threshold Code / Param": "激活阈值代码/参数",
    "Actions": "管理操作",

    // 7. Personalities Tab
    "AI Pedagogical Tutor Registry": "AI 智能教学导师个性管理中心",
    "Configure autonomous AI agent personas that guide students through course materials.": "配置在学习过程中引导学生的自主人工智能代理角色个性。",
    "Register Personality": "注册导师个性",
    "Socratic Coach": "苏格拉底式启发导师",
...
// Database States
  ...
  const handleDeployExpansion = (title: string, prerequisite: string, level: string, subject: string) => {
    ...
    if (isTooSimilarCourse || isTooSimilarInQueue) {
      alert(lang === 'FR' ? `Le cours de progression "${title}" existe déjà dans le catalogue ou dans la file d'attente avec un titre similaire !` : `The progression course "${title}" already exists in the catalog or in the queue with a similar title!`);
      return;
    }
  ...
  const handleCreateManualTask = () => {
    ...
    if (isTooSimilarCourse || isTooSimilarInQueue) {
      showToast(lang === 'FR' ? `Le cours ou curriculum "${title}" existe déjà avec un titre similaire à ce niveau !` : `The course or curriculum "${title}" already exists with a similar title at this level!`, 'info');
      return;
    }
  ...
  const handleApproveGen = (title: string, count: number, level?: string) => {
    ...
    if (isTooSimilarCourse || isTooSimilarInQueue) {
      showToast(lang === 'FR' ? `Le cours "${title}" existe déjà dans le catalogue ou dans la file d'attente avec un titre similaire à ce niveau !` : `The course "${title}" already exists in the catalog or in the queue with a similar title at this level!`, 'info');
      return;
    }
