...
Your mission is to design the structure, lesson titles, and cognitive strategy of the course titled "Introduction à l'Astrophysique" for the level "L1". You do not write the course content; you construct its pure, highly-adapted computational and educational backbone.
...
- **Course Title:** "Introduction à l'Astrophysique"
- **Target Level:** "L1"
- **Discipline:** "General"
- **Hourly Volume:** "15h"
- **Target Language:** "fr"
