...
### METADATA
- **Course Name**: "Introduction à l'Astrophysique"
- **Academic Level**: "L1"
- **Lesson Title**: "L'Univers à travers les Âges : Une Quête de Compréhension"
- **Lesson Slug**: "l-univers-a-travers-les-ages-une-quete-de-comprehension"
- **Target Language**: "FR"
- **Course Discipline**: "Général"
- **Epistemological Matrix**: "Sciences Empiriques / Expérimentales"
- **Expected Cognitive Artifact**: "Frise chronologique des découvertes majeures, Analyse conceptuelle"
- **Expected Guidelines / Technical Depth**: "Présentation historique et épistémologique des grandes étapes de l'astronomie et de l'astrophysique, des premières observations aux théories modernes. Accent sur les changements de paradigme et l'évolution de notre vision du cosmos."
