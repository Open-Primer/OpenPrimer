...
- **Academic Level**: "L1"
- **Lesson Title**: "Des Merveilles Célestes à la Science des Étoiles : Une Brève Histoire de l'Astronomie"
- **Lesson Slug**: "histoire-astronomie-astrophysique"
- **Target Language**: "FR"
- **Course Discipline**: "Général"
- **Epistemological Matrix**: "Sciences Empiriques / Expérimentales"
- **Expected Cognitive Artifact**: "Frise Chronologique Conceptuelle"
- **Expected Guidelines / Technical Depth**: "Présentation des grandes étapes de l'astronomie, des premières observations aux fondements de l'astrophysique moderne, contextualisation des enjeux et des questions fondamentales qui ont mené à la discipline."
