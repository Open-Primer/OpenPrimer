...
- **Academic Level**: "L1"
- **Lesson Title**: "Les Messagers de l'Univers : Lumière et Télescopes"
- **Lesson Slug**: "lumiere-telescopes-astrophysique"
- **Target Language**: "FR"
- **Course Discipline**: "Général"
- **Epistemological Matrix**: "Sciences Empiriques / Expérimentales"
- **Expected Cognitive Artifact**: "Diagramme Fonctionnel d'un Télescope / Spectre Électromagnétique"
- **Expected Guidelines / Technical Depth**: "Exploration du spectre électromagnétique comme outil d'information. Principes de base des télescopes optiques, radio, spatiaux et autres instruments d'observation, et comment ils révèlent les propriétés des objets célestes."
